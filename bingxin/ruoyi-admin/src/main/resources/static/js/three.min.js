...
THREE.Color.prototype = {
    constructor: THREE.Color, r: 1, g: 1, b: 1, copy: function (a) {
        ...
        var b =
            this.r, c = this.g, d = this.b, e = Math.max(Math.max(b, c), d), f = Math.min(Math.min(b, c), d);
        if (f === e) f = b = 0; else {
...
THREE.Vector3.prototype = {
    ...
    sub: function (a, b) {
        ...
        var d = a.elements, e = d[0], f = d[4], g = d[8], h = d[1], i = d[5], j = d[9], l = d[2], m = d[6], d = d[10];
        void 0 === b || "XYZ" === b ? (this.y = Math.asin(c(g)), 0.99999 > Math.abs(g) ? (this.x = Math.atan2(-j, d), this.z = Math.atan2(-f, e)) : (this.x = Math.atan2(m, i), this.z = 0)) : "YXZ" === b ? (this.x = Math.asin(-c(j)), 0.99999 > Math.abs(j) ?
        ...
        void 0 === b || "XYZ" === b ? (this.x = Math.atan2(2 * (a.x * a.w - a.y * a.z), g - d - e + f), this.y = Math.asin(c(2 * (a.x * a.z + a.y * a.w))), this.z = Math.atan2(2 * (a.z * a.w - a.x * a.y), g + d - e - f)) : "YXZ" === b ? (this.x = Math.asin(c(2 * (a.x * a.w - a.y * a.z))), this.y = Math.atan2(2 *
            ...
            a.z * a.w)))) : "XZY" === b && (this.x = Math.atan2(2 * (a.x * a.w + a.y * a.z), g - d + e - f), this.y = Math.atan2(2 * (a.x * a.z + a.y * a.w), g + d - e - f), this.z = Math.asin(c(2 * (a.z * a.w - a.x * a.y))));
        return this
...
THREE.Matrix3.prototype = {
    constructor: THREE.Matrix3, multiplyVector3: function (a) {
        ...
        for (var b = THREE.Matrix3.__v1, c = 0, d = a.length; c < d; c += 3) b.x = a[c], b.y = a[c + 1], b.z = a[c + 2], this.multiplyVector3(b), a[c] = b.x, a[c + 1] = b.y, a[c + 2] = b.z;
        return a
    }, getInverse: function (a) {
        var b = a.elements, a = b[10] * b[5] - b[6] * b[9], c = -b[10] * b[1] + b[2] * b[9],
            d = b[6] * b[1] - b[2] * b[5], e = -b[10] *
            b[4] + b[6] * b[8], f = b[10] * b[0] - b[2] * b[8], g = -b[6] * b[0] + b[2] * b[4],
            h = b[9] * b[4] - b[5] * b[8], i = -b[9] * b[0] + b[1] * b[8], j = b[5] * b[0] - b[1] * b[4],
            b = b[0] * a + b[1] * e + b[2] * h;
...
THREE.Matrix4 = function (a, b, c, d, e, f, g, h, i, j, l, m, n, p, o, s) {
    ...
    this.set(void 0 !== a ? a : 1, b || 0, c || 0, d || 0, e || 0, void 0 !== f ? f : 1, g || 0, h || 0, i || 0, j || 0, void 0 !== l ? l : 1, m || 0, n || 0, p || 0, o || 0, void 0 !== s ? s : 1)
};
THREE.Matrix4.prototype = {
    constructor: THREE.Matrix4, set: function (a, b, c, d, e, f, g, h, i, j, l, m, n, p, o, s) {
        var t = this.elements;
        t[0] = a;
        t[4] = b;
        t[8] = c;
        ...
        var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], i = c[12], j = c[1],
            l = c[5], m = c[9], n = c[13], p = c[2], o = c[6], s = c[10], t = c[14], r = c[3], z = c[7], w = c[11],
            c = c[15], q = d[0], E = d[4], A = d[8],
            v = d[12], u = d[1], D = d[5], C = d[9], G = d[13], P = d[2], B = d[6], K = d[10], H = d[14], I = d[3],
            N = d[7], O = d[11], d = d[15];
        e[0] = f * q + g * u + h * P + i * I;
        e[4] = f * E + g * D + h * B + i * N;
        e[8] = f * A + g * C + h * K + i * O;
        ...
        var a =
                this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], g = a[5], h = a[9], i = a[13], j = a[2],
            l = a[6], m = a[10], n = a[14], p = a[3], o = a[7], s = a[11], a = a[15];
        return e * h * l * p - d * i * l * p - e * g * m * p + c * i * m * p + d * g * n * p - c * h * n * p - e * h * j * o + d * i * j * o + e * f * m * o - b * i * m * o - d * f * n * o + b * h * n * o + e * g * j * s - c * i * j * s - e * f * l * s + b * i * l * s + c * f * n * s - b * g * n * s - d * g * j * a + c * h * j * a + d * f * l * a - b * h * l * a - c * f * m * a + b * g * m * a
    }, transpose: function () {
        ...
        var b =
                this.elements, c = a.elements, d = c[0], e = c[4], f = c[8], g = c[12], h = c[1], i = c[5], j = c[9],
            l = c[13], m = c[2], n = c[6], p = c[10], o = c[14], s = c[3], t = c[7], r = c[11], c = c[15];
        b[0] = j * o * t - l * p * t + l * n * r - i * o * r - j * n * c + i * p * c;
        b[4] = g * p * t - f * o * t - g * n * r + e * o * r + f * n * c - e * p * c;
        b[8] = f * l * t - g * j * t + g * i * r - e * l * r - f * i * c + e * j * c;
        b[12] = g * j * n - f * l * n - g * i * p + e * l * p + f * i * o - e * j * o;
        b[1] = l * p * s - j * o * s - l * m * r + h * o * r + j * m * c - h * p * c;
        b[5] = f * o * s - g * p * s + g * m * r - d * o * r - f * m * c + d * p * c;
        b[9] = g * j * s - f * l * s - g * h * r + d * l * r + f * h * c - d * j * c;
        b[13] = f * l * m - g * j * m + g * h * p - d * l * p - f * h * o + d * j * o;
        b[2] = i * o * s - l * n * s + l * m * t - h * o *
            t - i * m * c + h * n * c;
        b[6] = g * n * s - e * o * s - g * m * t + d * o * t + e * m * c - d * n * c;
        b[10] = e * l * s - g * i * s + g * h * t - d * l * t - e * h * c + d * i * c;
        b[14] = g * i * m - e * l * m - g * h * n + d * l * n + e * h * o - d * i * o;
        b[3] = j * n * s - i * p * s - j * m * t + h * p * t + i * m * r - h * n * r;
        b[7] = e * p * s - f * n * s + f * m * t - d * p * t - e * m * r + d * n * r;
        b[11] = f * i * s - e * j * s - f * h * t + d * j * t + e * h * r - d * i * r;
        b[15] = e * j * m - f * i * m + f * h * n - d * j * n - e * h * p + d * i * p;
        this.multiplyScalar(1 / a.determinant());
        return this
    }, setRotationFromEuler: function (a, b) {
        var c = this.elements, d = a.x, e = a.y, f = a.z, g = Math.cos(d), d = Math.sin(d), h = Math.cos(e),
            e = Math.sin(e), i = Math.cos(f), f =
                Math.sin(f);
        if (void 0 === b || "XYZ" === b) {
            var j = g * i, l = g * f, m = d * i, n = d * f;
            c[0] = h * i;
            c[4] = -h * f;
            c[8] = e;
            c[1] = l + m * e;
            ...
            l * e - m, c[2] = -e, c[6] = d * h, c[10] = g * h) : "YZX" === b ? (j = g * h, l = g * e, m = d * h, n = d * e, c[0] = h * i, c[4] = n - j * f, c[8] = m * f + l, c[1] = f, c[5] = g * i, c[9] = -d * i, c[2] = -e * i, c[6] = l * f + m, c[10] = j - n * f) : "XZY" === b && (j = g * h, l = g * e, m = d * h, n = d * e, c[0] = h * i, c[4] = -f, c[8] = e * i, c[1] = j * f + n, c[5] = g * i, c[9] = l * f - m, c[2] = m * f - l, c[6] = d * i, c[10] = n * f + j);
        return this
    }, setRotationFromQuaternion: function (a) {
        var b = this.elements, c = a.x, d = a.y, e = a.z, f = a.w, g = c + c, h = d + d, i = e + e, a = c * g,
            j = c * h, c = c * i, l = d * h, d = d * i, e = e * i, g = f * g, h = f * h, f = f * i;
        b[0] = 1 - (l + e);
        b[4] = j - f;
        b[8] = c + h;
        b[1] = j + f;
        ...
        var b = this.elements, c = b[4], d = b[5], e = b[6], f = b[7], g = b[8], h = b[9], i = b[10], j = b[11],
        ...
        var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], g = b[8], h = b[9], i = b[10], j = b[11],
            l = Math.cos(a), a = Math.sin(a);
        b[0] = l * c - a * g;
        b[1] = l * d - a * h;
        b[2] = l * e - a * i;
        ...
        var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], g = b[4], h = b[5], i = b[6], j = b[7],
            l = Math.cos(a), a = Math.sin(a);
        b[0] = l * c + a * g;
        b[1] = l * d + a * h;
        b[2] = l * e + a * i;
        ...
        var d = a.x, e = a.y, f = a.z,
            g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, i = f * f,
            j = Math.cos(b), l = Math.sin(b), m = 1 - j, n = d * e * m, p = d * f * m, m = e * f * m, d = d * l,
            o = e * l, l = f * l, f = g + (1 - g) * j, g = n + l, e = p - o, n = n - l, h = h + (1 - h) * j, l = m + d,
            p = p + o, m = m - d, i = i + (1 - i) * j, j = c[0], d = c[1], o = c[2], s = c[3], t = c[4], r = c[5],
            z = c[6], w = c[7], q = c[8], E = c[9], A = c[10], v = c[11];
        c[0] = f * j + g * t + e * q;
        c[1] = f * d + g * r + e * E;
        c[2] = f * o + g * z + e * A;
        c[3] = f * s + g * w + e * v;
...
THREE.Frustum.prototype.setFromMatrix = function (a) {
    var b = this.planes, c = a.elements, a = c[0], d = c[1], e = c[2], f = c[3], g = c[4], h = c[5], i = c[6], j = c[7],
        l = c[8], m = c[9], n = c[10], p = c[11], o = c[12], s = c[13], t = c[14], c = c[15];
...
(function (a) {
    ...
    var b = new a.Vector3, c = new a.Vector3, d = new a.Vector3, e = new a.Vector3;
    new a.Vector3;
    var f = new a.Vector3, g = new a.Matrix4, h = function (a, b) {
            return a.distance - b.distance
        }, i = new a.Vector3, j = new a.Vector3, l = new a.Vector3, m = function (a, b, c) {
            i.sub(c, a);
            var d = i.dot(b), a = j.add(a, l.copy(b).multiplyScalar(d));
            ...
            l.sub(a,
                b);
            var a = i.dot(i), b = i.dot(j), c = i.dot(l), e = j.dot(j), d = j.dot(l), f = 1 / (a * e - b * b),
                e = (e * c - b * d) * f, a = (a * d - b * c) * f;
            ...
            if (h instanceof a.Particle) {
                ...
                j.push({distance: l, point: h.position, face: null, object: h})
            } else if (h instanceof a.Mesh) {
                var o = h.geometry.boundingSphere.radius * h.matrixWorld.getMaxScaleOnAxis(),
                    l = m(i.origin, i.direction, h.matrixWorld.getPosition());
                if (l > o) return j;
                var o = h.geometry,
                    p = o.vertices, E = h.material instanceof a.MeshFaceMaterial,
                    A = !0 === E ? h.material.materials : null, l = h.material.side, v, u, D, C = i.precision;
                ...
                for (var G = 0, P = o.faces.length; G < P; G++) {
                    var B = o.faces[G], l = !0 === E ? A[B.materialIndex] : h.material;
                    if (void 0 !== l && (l = l.side, e.sub(B.centroid, c), u = B.normal, v = d.dot(u), !(Math.abs(v) < C) && (u = u.dot(e) / v, !(0 >
                        u) && (l === a.DoubleSide || (l === a.FrontSide ? 0 > v : 0 < v))))) if (f.add(c, d.multiplyScalar(u)), B instanceof a.Face3) l = p[B.a], v = p[B.b], u = p[B.c], n(f, l, v, u) && (v = h.matrixWorld.multiplyVector3(f.clone()), l = b.distanceTo(v), l < i.near || l > i.far || j.push({
                        distance: l,
                        point: v,
                        face: B,
                        faceIndex: G,
                        object: h
                    })); else if (B instanceof a.Face4 && (l = p[B.a], v = p[B.b], u = p[B.c], D = p[B.d], n(f, l, v, D) || n(f, v, u, D))) v = h.matrixWorld.multiplyVector3(f.clone()), l = b.distanceTo(v), l < i.near || l > i.far || j.push({
                        distance: l,
                        point: v,
                        face: B,
                        faceIndex: G,
        ...
        o = function (a, b, c) {
            for (var a = a.getDescendants(), d = 0, e = a.length; d < e; d++) p(a[d], b, c)
        };
    ...
    a.Ray.prototype.intersectObjects = function (a, b) {
        for (var c = [], d = 0, e = a.length; d < e; d++) p(a[d], this, c), !0 === b && o(a[d], this, c);
        c.sort(h);
        return c
    }
})(THREE);
...
THREE.Object3D.prototype = {
    ...
    traverse: function (a) {
        ...
        if (!0 === this.matrixWorldNeedsUpdate || !0 === a) void 0 === this.parent ? this.matrixWorld.copy(this.matrix) :
            this.matrixWorld.multiply(this.parent.matrixWorld, this.matrix), this.matrixWorldNeedsUpdate = !1, a = !0;
...
THREE.Projector = function () {
    ...
    var e, f, g = [], h = 0, i, j, l = [], m = 0, n, p, o = [], s = 0, t, r = [], z = 0, w, q, E = [], A = 0, v, u,
        D = [], C = 0, G = {objects: [], sprites: [], lights: [], elements: []}, P = new THREE.Vector3,
        B = new THREE.Vector4, K = new THREE.Matrix4, H = new THREE.Matrix4, I = new THREE.Matrix3,
        N = new THREE.Frustum, O = new THREE.Vector4, R = new THREE.Vector4;
    ...
    this.projectScene = function (g, h, m, Q) {
        var Z = h.near, L = h.far, oa = !1, X, fa, ca, Y, ba, aa, ia, Aa, Na, Ja, ma, sa, Ea, rb, ib;
        u = q = t = p = 0;
        G.elements.length = 0;
        g.updateMatrixWorld();
        ...
        m; g++) if (Aa = G.objects[g].object, Na = Aa.matrixWorld, j = 0, Aa instanceof THREE.Mesh) {
            ...
            X = 0;
            for (fa = ca.length; X < fa; X++) i = b(), i.positionWorld.copy(ca[X]), Na.multiplyVector3(i.positionWorld), i.positionScreen.copy(i.positionWorld), K.multiplyVector4(i.positionScreen), i.positionScreen.x /= i.positionScreen.w, i.positionScreen.y /= i.positionScreen.w,
                i.visible = i.positionScreen.z > Z && i.positionScreen.z < L;
            ca = 0;
            for (X = ma.length; ca < X; ca++) if (fa = ma[ca], ib = !0 === Ea ? rb.materials[fa.materialIndex] : Aa.material, void 0 !== ib) {
                aa = ib.side;
                ...
                s ? (sa = new THREE.RenderableFace3, o.push(sa), s++, p++, n = sa) : n = o[p++], n.v1.copy(Y), n.v2.copy(ba), n.v3.copy(ia); else continue; else continue; else if (fa instanceof THREE.Face4) if (Y = l[fa.a], ba = l[fa.b], ia = l[fa.c], sa = l[fa.d], !0 === Y.visible && !0 === ba.visible && !0 === ia.visible && !0 === sa.visible) if (oa = 0 > (sa.positionScreen.x - Y.positionScreen.x) * (ba.positionScreen.y - Y.positionScreen.y) - (sa.positionScreen.y - Y.positionScreen.y) * (ba.positionScreen.x - Y.positionScreen.x) || 0 > (ba.positionScreen.x - ia.positionScreen.x) * (sa.positionScreen.y -
                    ia.positionScreen.y) - (ba.positionScreen.y - ia.positionScreen.y) * (sa.positionScreen.x - ia.positionScreen.x), aa === THREE.DoubleSide || oa === (aa === THREE.FrontSide)) {
                    if (t === z) {
                ...
                !1 === oa && (aa === THREE.BackSide || aa === THREE.DoubleSide) && n.normalWorld.negate();
                ...
                ia = fa.vertexNormals;
                Y = 0;
                for (ba = ia.length; Y < ba; Y++) sa = n.vertexNormalsWorld[Y], sa.copy(ia[Y]), !1 === oa && (aa === THREE.BackSide || aa === THREE.DoubleSide) && sa.negate(), I.multiplyVector3(sa).normalize();
                n.vertexNormalsLength = ia.length;
                Y = 0;
                for (ba = Ja.length; Y < ba; Y++) if (sa = Ja[Y][ca], void 0 !== sa) {
                    aa = 0;
            ...
            X = 1;
            for (fa = ca.length; X < fa; X++) Y = b(), Y.positionScreen.copy(ca[X]), H.multiplyVector4(Y.positionScreen), 0 < (X + 1) % Na || (ba = l[j - 2], O.copy(Y.positionScreen), R.copy(ba.positionScreen), !0 === d(O, R) && (O.multiplyScalar(1 / O.w), R.multiplyScalar(1 / R.w), q === A ? (ma = new THREE.RenderableLine, E.push(ma), A++, q++, w = ma) : w = E[q++],
                w.v1.positionScreen.copy(O), w.v2.positionScreen.copy(R), w.z = Math.max(O.z, R.z), w.material = Aa.material, G.elements.push(w)))
        }
        g = 0;
        for (m = G.sprites.length; g < m; g++) Aa = G.sprites[g].object, Na = Aa.matrixWorld, Aa instanceof THREE.Particle && (B.set(Na.elements[12], Na.elements[13], Na.elements[14], 1), K.multiplyVector4(B), B.z /= B.w, 0 < B.z && 1 > B.z && (u === C ? (Z = new THREE.RenderableParticle, D.push(Z), C++, u++, v = Z) : v = D[u++], v.object = Aa, v.x = B.x / B.w, v.y = B.y / B.w, v.z = B.z, v.rotation = Aa.rotation.z, v.scale.x = Aa.scale.x * Math.abs(v.x -
            (B.x + h.projectionMatrix.elements[0]) / (B.w + h.projectionMatrix.elements[12])), v.scale.y = Aa.scale.y * Math.abs(v.y - (B.y + h.projectionMatrix.elements[5]) / (B.w + h.projectionMatrix.elements[13])), v.material = Aa.material, G.elements.push(v)));
...
THREE.Quaternion.prototype = {
    constructor: THREE.Quaternion, set: function (a, b, c, d) {
        ...
        b || (b = a);
        var c = a.x, d = a.y, e = a.z, f = this.x, g = this.y, h = this.z, i = this.w, j = i * c + g * e - h * d,
            l = i * d + h * c - f * e, m = i * e + f * d - g * c, c = -f * c - g * d - h * e;
        b.x = j * i + c * -f + l * -h - m * -g;
        b.y = l * i + c * -g + m * -f - j * -h;
        b.z = m * i + c * -h + j * -g - l * -f;
        return b
        ...
        var c =
            this.x, d = this.y, e = this.z, f = this.w, g = f * a.w + c * a.x + d * a.y + e * a.z;
...
THREE.Geometry.prototype = {
    constructor: THREE.Geometry, applyMatrix: function (a) {
        ...
        a = 0;
        for (b = this.faces.length; a < b; a++) c = this.faces[a], d = this.vertices[c.a], e = this.vertices[c.b], f = this.vertices[c.c], g.sub(f, e), h.sub(d, e), g.crossSelf(h), g.normalize(), c.normal.copy(g)
        ...
        if (void 0 === this.__tmpVertices) {
            ...
            b = 0;
            for (c = this.faces.length; b < c; b++) d = this.faces[b], d instanceof THREE.Face3 ? d.vertexNormals = [new THREE.Vector3, new THREE.Vector3,
        ...
        if (a) {
            var f, g, h, i = new THREE.Vector3, j = new THREE.Vector3, l = new THREE.Vector3, m = new THREE.Vector3,
                n = new THREE.Vector3;
            b = 0;
            for (c = this.faces.length; b < c; b++) d = this.faces[b], d instanceof THREE.Face3 ? (a = this.vertices[d.a], f = this.vertices[d.b], g = this.vertices[d.c], i.sub(g, f), j.sub(a, f), i.crossSelf(j),
            ...
            b = 0;
            for (c = this.faces.length; b < c; b++) d = this.faces[b], d instanceof THREE.Face3 ? (e[d.a].addSelf(d.normal), e[d.b].addSelf(d.normal), e[d.c].addSelf(d.normal)) :
    ...
    computeMorphNormals: function () {
        ...
        c = 0;
        for (d = this.faces.length; c < d; c++) e = this.faces[c], e.normal = e.__originalFaceNormal,
        ...
        var b, c, d, e, f, g, h, i, j, l, m, n, p, o, s, t, r, z,
            w, q, E, A, v, u, D = [], C = [], G = new THREE.Vector3, P = new THREE.Vector3, B = new THREE.Vector3,
            K = new THREE.Vector3, H = new THREE.Vector3;
        b = 0;
        for (c = this.vertices.length; b < c; b++) D[b] = new THREE.Vector3, C[b] = new THREE.Vector3;
        b = 0;
        ...
        for (var b =
            0, c = this.vertices.length; b < c; b++) {
        ...
        for (d = b.length; c < d; c++) {
            for (var e = b[c], f = [], g = 0, h = e.length; g < h; g++) f.push(new THREE.UV(e[g].u, e[g].v));
...
THREE.BufferGeometry.prototype = {
    constructor: THREE.BufferGeometry, applyMatrix: function (a) {
        ...
        this.boundingBox || (this.boundingBox = {
            min: new THREE.Vector3(Infinity,
        ...
        if (this.attributes.position && this.attributes.index) {
            ...
            var e = this.offsets, f = this.attributes.index.array, g = this.attributes.position.array,
                h = this.attributes.normal.array, i, j, l, m, n, p, o = new THREE.Vector3, s = new THREE.Vector3,
                t = new THREE.Vector3, r = new THREE.Vector3, z = new THREE.Vector3;
            c = 0;
            for (d = e.length; c < d; ++c) {
                ...
                var w = e[c].index;
                a = b;
                for (b += i; a < b; a += 3) i = w + f[a], j = w + f[a + 1], l = w + f[a + 2], m = g[3 * i], n = g[3 * i + 1], p = g[3 * i + 2], o.set(m, n, p), m = g[3 * j], n = g[3 * j + 1], p = g[3 * j + 2], s.set(m, n, p), m = g[3 * l], n = g[3 * l + 1], p = g[3 * l + 2], t.set(m, n, p), r.sub(t, s), z.sub(o,
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv) console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()"); else {
            ...
            var l, m, n, p, o, s, t, r, z, w, q, E, A, v, u, f = new THREE.Vector3, g = new THREE.Vector3, D, C, G, P,
                B, K, H, I = this.offsets;
            G = 0;
            for (P = I.length; G < P; ++G) {
                ...
                var N = I[G].index;
                D = C;
                for (C += B; D < C; D += 3) B = N + b[D], K = N + b[D + 1], H = N + b[D + 2], l = c[3 * B], m = c[3 * B + 1], n = c[3 * B + 2], p = c[3 * K], o = c[3 * K + 1], s = c[3 * K + 2], t = c[3 * H], r = c[3 * H + 1], z = c[3 *
            ...
            var O = new THREE.Vector3, R = new THREE.Vector3, ga = new THREE.Vector3, M = new THREE.Vector3, J, Q, Z;
            G = 0;
            for (P = I.length; G < P; ++G) {
                C = I[G].start;
                B = I[G].count;
...
THREE.Spline = function (a) {
    ...
    this.points = a;
    var c = [], d = {x: 0, y: 0, z: 0}, e, f, g, h, i, j, l, m, n;
...
THREE.Loader.prototype = {
    constructor: THREE.Loader, crossOrigin: "anonymous", addStatusElement: function () {
        ...
        function e(a, e, f, h, i, j, t) {
            var r = f.toLowerCase().endsWith(".dds"), z = b + "/" + f;
            if (r) {
            ...
            if (j && (f = {repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping},
            void 0 !== f[j[0]] && (a[e].wrapS = f[j[0]]), void 0 !== f[j[1]])) a[e].wrapT = f[j[1]];
            t && (a[e].anisotropy = t);
            if (!r) {
                var q = a[e], a = new Image;
                a.onload = function () {
        ...
        a.mapNormal ? (h = THREE.ShaderUtils.lib.normal, j = THREE.UniformsUtils.clone(h.uniforms), j.tNormal.value = i.normalMap, a.mapNormalFactor && j.uNormalScale.value.set(a.mapNormalFactor, a.mapNormalFactor), i.map && (j.tDiffuse.value = i.map, j.enableDiffuse.value = !0), i.specularMap && (j.tSpecular.value = i.specularMap, j.enableSpecular.value = !0), i.lightMap && (j.tAO.value = i.lightMap, j.enableAO.value = !0), j.uDiffuseColor.value.setHex(i.color),
            j.uSpecularColor.value.setHex(i.specular), j.uAmbientColor.value.setHex(i.ambient), j.uShininess.value = i.shininess, void 0 !== i.opacity && (j.uOpacity.value = i.opacity), i = new THREE.ShaderMaterial({
...
THREE.BinaryLoader.prototype.loadAjaxBuffers = function (a, b, c, d, e) {
    ...
    f.onreadystatechange = function () {
        ...
        } else console.error("THREE.BinaryLoader: Couldn't load [" + g + "] [" + f.status + "]"); else 3 == f.readyState ? e && (0 == h && (h = f.getResponseHeader("Content-Length")), e({
            total: h,
...
THREE.BinaryLoader.prototype.createBinModel = function (a, b, c, d) {
    var e = function () {
        ...
        function u(b, c) {
            var d, e, f, g, h, i, j, l = new Uint32Array(a, c, 3 * b);
            for (d = 0; d < b; d++) e = l[3 * d], f = l[3 * d + 1], g = l[3 * d + 2], h = N[2 * e], e = N[2 * e + 1], i = N[2 * f], j = N[2 * f + 1], f = N[2 * g], g = N[2 * g + 1], K.faceVertexUvs[0].push([new THREE.UV(h, e), new THREE.UV(i, j), new THREE.UV(f, g)])
        }

        function D(b,
                   c) {
            var d, e, f, g, h, i, j, l, n, m = new Uint32Array(a, c, 4 * b);
            for (d = 0; d < b; d++) e = m[4 * d], f = m[4 * d + 1], g = m[4 * d + 2], h = m[4 * d + 3], i = N[2 * e], e = N[2 * e + 1], j = N[2 * f], l = N[2 * f + 1], f = N[2 * g], n = N[2 * g + 1], g = N[2 * h], h = N[2 * h + 1], K.faceVertexUvs[0].push([new THREE.UV(i, e), new THREE.UV(j, l), new THREE.UV(f, n), new THREE.UV(g, h)])
        }

        function C(b, c, d) {
            for (var e, f, g, h, c = new Uint32Array(a, c, 3 * b), i = new Uint16Array(a, d, b), d = 0; d < b; d++) e = c[3 * d], f = c[3 * d + 1], g = c[3 * d + 2], h = i[d], K.faces.push(new THREE.Face3(e, f, g, null, null, h))
        }
        ...
        function P(b, c, d, e) {
            for (var f, g, h, i, j, l, n, c = new Uint32Array(a, c, 3 * b), d = new Uint32Array(a, d, 3 * b), m = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                ...
                n = d[3 * e + 2];
                i = m[e];
                var o = I[3 * l], p = I[3 * l + 1];
                l = I[3 * l + 2];
                var s = I[3 * n], r = I[3 * n + 1];
                n = I[3 * n + 2];
                K.faces.push(new THREE.Face3(f, g, h, [new THREE.Vector3(I[3 *
        ...
        function B(b, c, d, e) {
            for (var f, g, h, i, j, l, n, m, o, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), p = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                ...
                var s = I[3 * n], r = I[3 * n + 1];
                n = I[3 * n + 2];
                var q = I[3 * m], t = I[3 * m + 1];
                m = I[3 * m + 2];
                var u = I[3 * o], v = I[3 * o + 1];
                o = I[3 * o + 2];
                K.faces.push(new THREE.Face4(f, g, h, i, [new THREE.Vector3(I[3 * l], I[3 * l + 1], I[3 * l + 2]), new THREE.Vector3(s,
                    r, n), new THREE.Vector3(q, t, m), new THREE.Vector3(u, v, o)], null, j))
            }
        }

        var K = this, H = 0, I = [], N = [], O, R, ga;
        ...
        e = w * (ga + 4 * e);
        ga = H;
        var H = new Float32Array(a, H, 3 * l), M, J, Q, Z;
        for (M = 0; M < l; M++) J = H[3 * M], Q = H[3 * M + 1], Z = H[3 * M + 2], K.vertices.push(new THREE.Vector3(J, Q, Z));
        l = H = ga + 3 * l * Float32Array.BYTES_PER_ELEMENT;
        if (m) {
            H = new Int8Array(a, H, 3 * m);
            for (ga = 0; ga < m; ga++) M = H[3 * ga], J = H[3 * ga + 1], Q = H[3 * ga + 2], I.push(M / 127, J / 127, Q / 127)
        }
        H = l + 3 * m * Int8Array.BYTES_PER_ELEMENT;
        m = H += E(3 * m);
        if (n) {
            l = new Float32Array(a, H, 2 * n);
            for (H = 0; H < n; H++) ga = l[2 * H], M = l[2 * H + 1], N.push(ga, M)
        }
        ...
        j = R + d + E(2 * z);
        d = j + e + E(2 * w);
        s && (e = m + 3 * s * Uint32Array.BYTES_PER_ELEMENT, C(s, m, e + 3 * s * Uint32Array.BYTES_PER_ELEMENT), u(s, e));
        t && (s = b + 3 * t * Uint32Array.BYTES_PER_ELEMENT, e = s + 3 * t * Uint32Array.BYTES_PER_ELEMENT, P(t, b, s, e + 3 * t * Uint32Array.BYTES_PER_ELEMENT), u(t, e));
        w && (t = j + 4 * w * Uint32Array.BYTES_PER_ELEMENT, G(w, j, t + 4 * w * Uint32Array.BYTES_PER_ELEMENT), D(w, t));
        q && (w = d + 4 * q * Uint32Array.BYTES_PER_ELEMENT, t = w + 4 * q * Uint32Array.BYTES_PER_ELEMENT, B(q, d, w, t + 4 *
            q * Uint32Array.BYTES_PER_ELEMENT), D(q, t));
        p && C(p, n, n + 3 * p * Uint32Array.BYTES_PER_ELEMENT);
        o && (p = O + 3 * o * Uint32Array.BYTES_PER_ELEMENT, P(o, O, p, p + 3 * o * Uint32Array.BYTES_PER_ELEMENT));
        r && G(r, c, c + 4 * r * Uint32Array.BYTES_PER_ELEMENT);
        z && (o = R + 4 * z * Uint32Array.BYTES_PER_ELEMENT, B(z, R, o, o + 4 * z * Uint32Array.BYTES_PER_ELEMENT));
...
THREE.JSONLoader.prototype.loadAjaxJSON = function (a, b, c, d, e) {
    ...
    f.onreadystatechange = function () {
        if (f.readyState === f.DONE) if (200 === f.status || 0 === f.status) {
            ...
            a.onLoadComplete()
        } else console.error("THREE.JSONLoader: Couldn't load [" + b + "] [" + f.status + "]"); else f.readyState ===
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
    var d = new THREE.Geometry, e = void 0 !== a.scale ? 1 / a.scale : 1, f, g, h, i, j, l, m, n, p, o, s, t, r, z, w,
        q = a.faces;
    o = a.vertices;
    var E = a.normals, A = a.colors, v = 0;
    for (f = 0; f < a.uvs.length; f++) a.uvs[f].length && v++;
    for (f = 0; f < v; f++) d.faceUvs[f] = [], d.faceVertexUvs[f] = [];
    i = 0;
    for (j = o.length; i < j;) l = new THREE.Vector3, l.x = o[i++] * e, l.y = o[i++] * e, l.z = o[i++] * e, d.vertices.push(l);
    i = 0;
    for (j = q.length; i < j;) {
        o = q[i++];
        l = o & 1;
        ...
        o &= 128;
        l ? (t = new THREE.Face4,
            t.a = q[i++], t.b = q[i++], t.c = q[i++], t.d = q[i++], l = 4) : (t = new THREE.Face3, t.a = q[i++], t.b = q[i++], t.c = q[i++], l = 3);
        h && (h = q[i++], t.materialIndex = h);
        h = d.faces.length;
        if (f) for (f = 0; f < v; f++) r = a.uvs[f], p = q[i++], w = r[2 * p], p = r[2 * p + 1], d.faceUvs[f][h] = new THREE.UV(w, p);
        if (g) for (f = 0; f < v; f++) {
            r = a.uvs[f];
            z = [];
            for (g = 0; g < l; g++) p = q[i++], w = r[2 * p], p = r[2 * p + 1], z[g] = new THREE.UV(w, p);
            d.faceVertexUvs[f][h] = z
        }
        n && (n = 3 * q[i++], g = new THREE.Vector3, g.x = E[n++], g.y = E[n++], g.z = E[n], t.normal = g);
        if (m) for (f = 0; f < l; f++) n = 3 * q[i++], g = new THREE.Vector3,
            g.x = E[n++], g.y = E[n++], g.z = E[n], t.vertexNormals.push(g);
        s && (m = q[i++], m = new THREE.Color(A[m]), t.color = m);
        if (o) for (f = 0; f < l; f++) m = q[i++], m = new THREE.Color(A[m]), t.vertexColors.push(m);
        d.faces.push(t)
    }
    if (a.skinWeights) {
        i = 0;
        for (j = a.skinWeights.length; i < j; i += 2) q = a.skinWeights[i], E = a.skinWeights[i + 1], d.skinWeights.push(new THREE.Vector4(q, E, 0, 0))
    }
    if (a.skinIndices) {
        i = 0;
        for (j = a.skinIndices.length; i < j; i += 2) q = a.skinIndices[i], E = a.skinIndices[i + 1], d.skinIndices.push(new THREE.Vector4(q, E, 0, 0))
    }
    d.bones = a.bones;
    ...
    if (void 0 !== a.morphTargets) {
        ...
        for (j = a.morphTargets.length; i < j; i++) {
            ...
            q = 0;
            for (E = v.length; q < E; q += 3) o = new THREE.Vector3, o.x = v[q] * e, o.y = v[q + 1] * e, o.z = v[q + 2] * e, A.push(o)
        }
    }
    if (void 0 !== a.morphColors) {
        ...
        for (j = a.morphColors.length; i < j; i++) {
            ...
            e = 0;
            for (q = A.length; e < q; e += 3) v = new THREE.Color(16755200), v.setRGB(A[e], A[e + 1], A[e + 2]), E.push(v)
        }
    }
    d.computeCentroids();
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    function f(a, b) {
        for (var c in b) if (void 0 === M.objects[c]) {
            ...
            if (e.type && e.type in l.hierarchyHandlerMap && void 0 === e.loading) {
                ...
                n.addEventListener ? (n.addEventListener("load", h(c, a, C, e)), n.load(d(e.url, Q.urlBaseType))) :
                ...
                if (D = M.geometries[e.geometry]) {
                    ...
                    r = e.matrix;
                    E = 0;
                    e.material || (C = new THREE.MeshFaceMaterial(M.face_materials[e.geometry]));
                    C instanceof THREE.MeshFaceMaterial && 0 === C.materials.length && (C = new THREE.MeshFaceMaterial(M.face_materials[e.geometry]));
                    if (C instanceof THREE.MeshFaceMaterial) for (i =
                                                                      0; i < C.materials.length; i++) g = g || C.materials[i] instanceof THREE.ShaderMaterial;
                    g && D.computeTangents();
                    e.skin ? g = new THREE.SkinnedMesh(D, C) : e.morph ? (g = new THREE.MorphAnimMesh(D, C), void 0 !== e.duration && (g.duration = e.duration), void 0 !== e.time && (g.time = e.time), void 0 !== e.mirroredLoop && (g.mirroredLoop = e.mirroredLoop), C.morphNormals && D.computeMorphNormals()) : g = new THREE.Mesh(D, C);
                    g.name = c;
                    r ? (g.matrixAutoUpdate = !1, g.matrix.set(r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[12], r[13], r[14],
                        r[15])) : (g.position.set(w[0], w[1], w[2]), E ? (g.quaternion.set(E[0], E[1], E[2], E[3]), g.useQuaternion = !0) : g.rotation.set(q[0], q[1], q[2]), g.scale.set(A[0], A[1], A[2]));
                    g.visible = e.visible;
                ...
                w[1], w[2]), e.target && (J.push({
                object: K,
                targetName: e.target
            }), K.target = null)) : "PointLight" === e.type ? (w = e.position, z = e.distance, K = new THREE.PointLight(H, I, z), K.position.set(w[0], w[1], w[2])) : "AmbientLight" === e.type && (K = new THREE.AmbientLight(H)), a.add(K), K.name = c, M.lights[c] = K, M.objects[c] = K) : "PerspectiveCamera" === e.type || "OrthographicCamera" === e.type ? ("PerspectiveCamera" === e.type ? G = new THREE.PerspectiveCamera(e.fov, e.aspect, e.near, e.far) : "OrthographicCamera" === e.type && (G = new THREE.OrthographicCamera(v.left,
                v.right, v.top, v.bottom, v.near, v.far)), w = e.position, G.position.set(w[0], w[1], w[2]), a.add(G), G.name = c, M.cameras[c] = G, M.objects[c] = G) : (w = e.position, q = e.rotation, E = e.quaternion, A = e.scale, E = 0, g = new THREE.Object3D, g.name = c, g.position.set(w[0], w[1], w[2]), E ? (g.quaternion.set(E[0], E[1], E[2], E[3]), g.useQuaternion = !0) : g.rotation.set(q[0], q[1], q[2]), g.scale.set(A[0], A[1], A[2]), g.visible = void 0 !== e.visible ? e.visible : !1, a.add(g), M.objects[c] = g, M.empties[c] = g);
            if (g) {
    ...
    function j() {
        l.callbackProgress({totalModels: R, totalTextures: ga, loadedModels: R - N, loadedTextures: ga - O}, M);
        l.onLoadProgress();
        if (0 === N && 0 === O) {
            for (var a = 0; a < J.length; a++) {
                var c = J[a], d = M.objects[c.targetName];
                d ? c.object.target = d : (c.object.target = new THREE.Object3D, M.scene.add(c.object.target));
    ...
    var l = this, m = THREE.Loader.prototype.extractUrlBase(c),
        n, p, o, s, t, r, z, w, q, E, A, v, u, D, C, G, P, B, K, H, I, N, O, R, ga, M, J = [], Q = a, Z;
    for (Z in this.geometryHandlerMap) a = this.geometryHandlerMap[Z].loaderClass, this.geometryHandlerMap[Z].loaderObject = new a;
    for (Z in this.hierarchyHandlerMap) a = this.hierarchyHandlerMap[Z].loaderClass, this.hierarchyHandlerMap[Z].loaderObject = new a;
    O = N = 0;
    M = {
    ...
    if (Q.transform && (Z = Q.transform.position, a = Q.transform.rotation,
        c = Q.transform.scale, Z && M.scene.position.set(Z[0], Z[1], Z[2]), a && M.scene.rotation.set(a[0], a[1], a[2]), c && M.scene.scale.set(c[0], c[1], c[2]), Z || a || c)) M.scene.updateMatrix(), M.scene.updateMatrixWorld();
    Z = function (a) {
        return function () {
            O -= a;
            j();
    ...
    for (o in Q.fogs) a = Q.fogs[o], "linear" === a.type ? P = new THREE.Fog(0, a.near, a.far) : "exp2" === a.type && (P = new THREE.FogExp2(0, a.density)), v = a.color, P.color.setRGB(v[0], v[1], v[2]), M.fogs[o] = P;
    for (n in Q.geometries) t = Q.geometries[n], t.type in this.geometryHandlerMap &&
    (N += 1, l.onLoadStart());
    for (var L in Q.objects) o = Q.objects[L], o.type && o.type in this.hierarchyHandlerMap && (N += 1, l.onLoadStart());
    R = N;
    for (n in Q.geometries) if (t = Q.geometries[n], "cube" === t.type) D = new THREE.CubeGeometry(t.width, t.height, t.depth, t.widthSegments, t.heightSegments, t.depthSegments), M.geometries[n] = D; else if ("plane" === t.type) D = new THREE.PlaneGeometry(t.width, t.height, t.widthSegments, t.heightSegments), M.geometries[n] = D; else if ("sphere" === t.type) D = new THREE.SphereGeometry(t.radius, t.widthSegments,
        ...
        this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,
            Q.urlBaseType), g(n), L)
    } else "embedded" === t.type && (L = Q.embeds[t.id], L.metadata = Q.metadata, L && this.geometryHandlerMap.ascii.loaderObject.createModel(L, i(n), ""));
    for (s in Q.textures) if (n = Q.textures[s], n.url instanceof Array) {
        O += n.url.length;
    ...
    for (s in Q.textures) {
        n = Q.textures[s];
        void 0 !== n.mapping && void 0 !== THREE[n.mapping] && (n.mapping = new THREE[n.mapping]);
        if (n.url instanceof Array) {
            L = n.url.length;
            o = [];
            for (B = 0; B < L; B++) o[B] = d(n.url[B],
                Q.urlBaseType);
            B = (B = o[0].endsWith(".dds")) ? THREE.ImageUtils.loadCompressedTextureCube(o, n.mapping, Z(L)) : THREE.ImageUtils.loadTextureCube(o, n.mapping, Z(L))
        } else {
            B = n.url.toLowerCase().endsWith(".dds");
            L = d(n.url, Q.urlBaseType);
            o = Z(1);
            B = B ? THREE.ImageUtils.loadCompressedTexture(L, n.mapping, o) : THREE.ImageUtils.loadTexture(L, n.mapping, o);
            ...
            if (n.repeat &&
                (B.repeat.set(n.repeat[0], n.repeat[1]), 1 !== n.repeat[0] && (B.wrapS = THREE.RepeatWrapping), 1 !== n.repeat[1])) B.wrapT = THREE.RepeatWrapping;
            n.offset && B.offset.set(n.offset[0], n.offset[1]);
            if (n.wrap && (L = {
                repeat: THREE.RepeatWrapping,
                mirror: THREE.MirroredRepeatWrapping
            }, void 0 !== L[n.wrap[0]] && (B.wrapS = L[n.wrap[0]]), void 0 !== L[n.wrap[1]])) B.wrapT = L[n.wrap[1]]
        }
        M.textures[s] = B
    }
    for (p in Q.materials) {
        r = Q.materials[p];
        for (u in r.parameters) "envMap" === u || "map" === u || "lightMap" === u || "bumpMap" === u ? r.parameters[u] = M.textures[r.parameters[u]] :
            "shading" === u ? r.parameters[u] = "flat" === r.parameters[u] ? THREE.FlatShading : THREE.SmoothShading : "side" === u ? r.parameters[u] = "double" == r.parameters[u] ? THREE.DoubleSide : "back" == r.parameters[u] ? THREE.BackSide : THREE.FrontSide : "blending" === u ? r.parameters[u] = r.parameters[u] in THREE ? THREE[r.parameters[u]] : THREE.NormalBlending : "combine" === u ? r.parameters[u] = "MixOperation" == r.parameters[u] ? THREE.MixOperation : THREE.MultiplyOperation : "vertexColors" === u ? "face" == r.parameters[u] ? r.parameters[u] = THREE.FaceColors : r.parameters[u] &&
                (r.parameters[u] = THREE.VertexColors) : "wrapRGB" === u && (s = r.parameters[u], r.parameters[u] = new THREE.Vector3(s[0], s[1], s[2]));
    ...
    for (p in Q.materials) if (r =
        Q.materials[p], r.parameters.materials) {
        u = [];
        for (B = 0; B < r.parameters.materials.length; B++) u.push(M.materials[r.parameters.materials[B]]);
        M.materials[p].materials = u
    }
    e();
    M.cameras && Q.defaults.camera && (M.currentCamera = M.cameras[Q.defaults.camera]);
...
THREE.Sprite = function (a) {
    ...
    this.useScreenCoordinates = void 0 !==
    a.useScreenCoordinates ? a.useScreenCoordinates : !0;
    ...
    this.alignment = a.alignment instanceof THREE.Vector2 ? a.alignment : THREE.SpriteAlignment.center.clone();
...
THREE.CanvasRenderer = function (a) {
    ...
    function c(a) {
        w !== a && (a === THREE.NormalBlending ? s.globalCompositeOperation = "source-over" : a === THREE.AdditiveBlending ? s.globalCompositeOperation = "lighter" : a === THREE.SubtractiveBlending && (s.globalCompositeOperation = "darker"), w = a)
    }
    ...
    var a = a || {}, f = this, g, h, i, j = new THREE.Projector, l = void 0 !== a.canvas ? a.canvas :
        document.createElement("canvas"), m, n, p, o, s = l.getContext("2d"), t = new THREE.Color(0), r = 0, z = 1,
        w = 0, q = null, E = null, A = null, v = null, u = null, D, C, G, P, B = new THREE.RenderableVertex,
        K = new THREE.RenderableVertex, H, I, N, O, R, ga, M, J, Q, Z, L, oa, X = new THREE.Color, fa = new THREE.Color,
        ca = new THREE.Color, Y = new THREE.Color, ba = new THREE.Color, aa = new THREE.Color, ia = new THREE.Color,
        Aa = {}, Na = {}, Ja, ma, sa, Ea, rb, ib, ob, jb, Bb, Cb, Wa = new THREE.Rectangle, Sa = new THREE.Rectangle,
        Ka = new THREE.Rectangle, kb = !1, Oa = new THREE.Color, lb = new THREE.Color,
        ab = new THREE.Color, va = new THREE.Vector3, eb, pb, bb, xa, mb, sb, a = 16;
    ...
    this.clear = function () {
        ...
        !1 === Sa.isEmpty() && (Sa.minSelf(Wa), Sa.inflate(2), 1 > r && s.clearRect(Math.floor(Sa.getX()), Math.floor(Sa.getY()), Math.floor(Sa.getWidth()),
    ...
    this.render = function (a, l) {
        ...
        function z(a, b, c, d, f, g, h, k, i, j, l, n, na) {
            if (!(na instanceof THREE.DataTexture || void 0 === na.image || 0 == na.image.width)) {
                if (!0 === na.needsUpdate) {
                    var m = na.wrapS == THREE.RepeatWrapping, o = na.wrapT == THREE.RepeatWrapping;
                    Aa[na.id] = s.createPattern(na.image, !0 === m && !0 === o ? "repeat" : !0 === m && !1 === o ? "repeat-x" : !1 === m && !0 === o ? "repeat-y" : "no-repeat");
                    na.needsUpdate = !1
                }
                void 0 === Aa[na.id] ? e("rgba(0,0,0,1)") : e(Aa[na.id]);
                var m = na.offset.x / na.repeat.x, o = na.offset.y / na.repeat.y,
                    Db = na.image.width * na.repeat.x, p = na.image.height * na.repeat.y, h = (h + m) * Db,
                    k = (1 - k + o) * p, c = c - a, d = d - b, f = f - a, g = g - b, i = (i + m) * Db - h,
                    j = (1 - j + o) * p - k, l = (l + m) * Db - h, n = (1 - n + o) * p - k, m = i * n - l * j;
                0 === m ? (void 0 === Na[na.id] && (b = document.createElement("canvas"), b.width = na.image.width, b.height = na.image.height, b = b.getContext("2d"), b.drawImage(na.image, 0, 0), Na[na.id] = b.getImageData(0, 0, na.image.width, na.image.height).data), b = Na[na.id], h = 4 * (Math.floor(h) + Math.floor(k) * na.image.width), X.setRGB(b[h] / 255, b[h + 1] / 255, b[h + 2] / 255), w(X)) :
        ...
        if (!1 === l instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            if (!0 === kb) {
                ...
                for (zc = i.length; $b < zc; $b++) {
                    da = i[$b];
                    var la = da.color;
                    da instanceof THREE.AmbientLight ? (Oa.r += la.r, Oa.g += la.g, Oa.b += la.b) : da instanceof THREE.DirectionalLight ? (lb.r += la.r, lb.g += la.g, lb.b += la.b) : da instanceof THREE.PointLight &&
                        (ab.r += la.r, ab.g += la.g, ab.b += la.b)
                }
            }
            $b = 0;
            for (zc = h.length; $b < zc; $b++) if (ka = h[$b], da = ka.material, !(void 0 === da || !1 === da.visible)) {
                Ka.empty();
                if (ka instanceof THREE.RenderableParticle) {
                    ...
                    b(da.opacity);
                    c(da.blending);
                    var E = void 0, Ab = void 0, tb = void 0, ub = void 0, jc = ka = void 0, Rc = void 0;
                    da instanceof THREE.ParticleBasicMaterial ? null === da.map ? (tb = cb.object.scale.x, ub = cb.object.scale.y, tb *= cb.scale.x * p, ub *= cb.scale.y * o, Ka.set(la.x - tb, la.y - ub, la.x + tb, la.y + ub), !1 !== Wa.intersects(Ka) &&
                    ...
                    Ja, ma), Y.r = Y.g = Y.b = 1 - Db(Ab.positionScreen.z, Ja, ma), ba.r = ba.g = ba.b = 1 - Db(E.positionScreen.z, Ja, ma), sa = yc(fa, ca, Y, ba), r(H, I, N, O, M, J), na(H, I, N, O, M, J, 0, 0, 1, 0, 0, 1, sa), r(Q, Z, R, ga, L, oa), na(Q, Z, R, ga, L, oa, 1, 0, 1, 1, 0, 1, sa));
                Sa.addRectangle(Ka)
            }
...
THREE.ShaderLib = {
    depth: {
        ...
        uniforms: {},
        vertexShader: [THREE.ShaderChunk.morphtarget_pars_vertex, THREE.ShaderChunk.skinning_pars_vertex, "void main() {", THREE.ShaderChunk.skinbase_vertex, THREE.ShaderChunk.morphtarget_vertex, THREE.ShaderChunk.skinning_vertex,
...
THREE.WebGLRenderer = function (a) {
    function b(a) {
        if (a.__webglCustomAttributesList) for (var b in a.__webglCustomAttributesList) k.deleteBuffer(a.__webglCustomAttributesList[b].buffer)
    }
    ...
    function d(a, b) {
        var c = b.geometry, d = a.faces3, h = a.faces4, i = 3 * d.length + 4 * h.length,
            j = 1 * d.length + 2 * h.length, h = 3 * d.length + 4 * h.length, d = e(b, a), l = g(d), n = f(d),
        ...
        if (d.attributes) {
            ...
            for (var o in d.attributes) {
                var j = d.attributes[o], c = {}, p;
                for (p in j) c[p] = j[p];
                if (!c.__webglInitialized || c.createUniqueBuffers) c.__webglInitialized = !0, h = 1, "v2" === c.type ? h = 2 :
                    "v3" === c.type ? h = 3 : "v4" === c.type ? h = 4 : "c" === c.type && (h = 3), c.size = h, c.array = new Float32Array(i * h), c.buffer = k.createBuffer(), c.buffer.belongsToAttribute = o, j.needsUpdate = !0, c.__original = j;
    ...
    function i(a, b, c) {
        ...
        g = h.length;
        var i = a.colors, j = i.length, l = a.__vertexArray, n = a.__colorArray, m = a.__sortArray,
            o = a.verticesNeedUpdate, p = a.colorsNeedUpdate, s = a.__webglCustomAttributesList;
        if (c.sortParticles) {
            pb.copy(eb);
            pb.multiplySelf(c.matrixWorld);
            for (d = 0; d < g; d++) e = h[d], bb.copy(e), pb.multiplyVector3(bb), m[d] = [bb.z, d];
            m.sort(function (a, b) {
                return b[0] - a[0]
            });
            ...
            if (s) {
                i = 0;
                for (j = s.length; i < j; i++) if (h = s[i], void 0 === h.boundTo || "vertices" === h.boundTo) if (f = 0, e = h.value.length, 1 === h.size) for (d =
            ...
            if (o) for (d =
                            0; d < g; d++) e = h[d], f = 3 * d, l[f] = e.x, l[f + 1] = e.y, l[f + 2] = e.z;
            if (p) for (d = 0; d < j; d++) e = i[d], f = 3 * d, n[f] = e.r, n[f + 1] = e.g, n[f + 2] = e.b;
            if (s) {
                i = 0;
                for (j = s.length; i < j; i++) if (h = s[i], h.needsUpdate && (void 0 === h.boundTo || "vertices" === h.boundTo)) if (e = h.value.length, f = 0, 1 === h.size) for (d = 0; d < e; d++) h.array[d] = h.value[d]; else if (2 === h.size) for (d = 0; d < e; d++) g = h.value[d], h.array[f] = g.x, h.array[f + 1] = g.y, f += 2; else if (3 === h.size) if ("c" === h.type) for (d = 0; d < e; d++) g = h.value[d], h.array[f] = g.r, h.array[f + 1] = g.g, h.array[f + 2] = g.b, f += 3; else for (d =
        ...
        if (s) {
            i = 0;
            for (j = s.length; i < j; i++) if (h = s[i], h.needsUpdate || c.sortParticles) k.bindBuffer(k.ARRAY_BUFFER,
    ...
    function j(a, b, c) {
        ...
        a.elementsNeedUpdate && void 0 !== e && (k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.buffer), k.bufferData(k.ELEMENT_ARRAY_BUFFER, e.array, b));
        ...
        a.colorsNeedUpdate && void 0 !== i && (k.bindBuffer(k.ARRAY_BUFFER, i.buffer), k.bufferData(k.ARRAY_BUFFER, i.array, b));
    ...
    function p(a, b, c, d, e, f, g, h) {
        ...
        for (var n = k; n !== b; n += l) if (i = a[n], i.render) {
            k = i.object;
            j = i.buffer;
            if (h) i = h; else {
                i = i[c];
                if (!i) continue;
                g && L.setBlending(i.blending, i.blendEquation, i.blendSrc, i.blendDst);
    ...
    function o(a, b, c, d, e, f, g) {
        for (var h, i, k = 0, j = a.length; k < j; k++) if (h = a[k], i = h.object, i.visible) {
            if (g) h = g; else {
                h = h[b];
                if (!h) continue;
    ...
    function q(a, b, c, d, e) {
        Aa = 0;
        d.needsUpdate && (d.program && L.deallocateMaterial(d), L.initMaterial(d, b, c, e), d.needsUpdate = !1);
        d.morphTargets && !e.__webglMorphTargetInfluences && (e.__webglMorphTargetInfluences =
            new Float32Array(L.maxMorphTargets));
        var f = !1, g = d.program, h = g.uniforms, i = d.uniforms;
        g !== fa && (k.useProgram(g), fa = g, f = !0);
        d.id !== Y && (Y = d.id, f = !0);
        if (f || a !== aa) k.uniformMatrix4fv(h.projectionMatrix, !1, a._projectionMatrixArray), a !== aa && (aa = a);
        if (d.skinning) if (hc && e.useVertexTexture) {
        ...
        if (f) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (mb) {
                    for (var l = 0, n = 0, m = 0, o, p, s, r = sb, q = r.directional.colors, t = r.directional.positions, w = r.point.colors, z = r.point.positions, A = r.point.distances, B = r.spot.colors, C = r.spot.positions, D = r.spot.distances, G = r.spot.directions, X = r.spot.anglesCos, J = r.spot.exponents, K = r.hemi.skyColors,
                        ...
                        j.exponent, N += 1)) : j instanceof THREE.HemisphereLight && (ga += 1, j.visible && (o = j.color, p = j.groundColor, qa = 3 * R, L.gammaInput ? (s *= s, v(K, qa, o, s), v(Q, qa, p, s)) : (u(K, qa, o, s), u(Q, qa, p, s)), xa.copy(j.matrixWorld.getPosition()), xa.normalize(), M[qa] = xa.x, M[qa + 1] = xa.y, M[qa + 2] = xa.z, R += 1)));
                    c = 3 * O;
            ...
            if (d instanceof THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.MeshPhongMaterial) {
                ...
                var T;
                d.map ? T = d.map : d.specularMap ? T = d.specularMap : d.normalMap ? T = d.normalMap : d.bumpMap && (T = d.bumpMap);
                void 0 !== T && (c = T.offset, T = T.repeat, i.offsetRepeat.value.set(c.x, c.y, T.x, T.y));
                i.envMap.value = d.envMap;
                i.flipEnvMap.value = d.envMap instanceof THREE.WebGLRenderTargetCube ? 1 : -1;
                i.reflectivity.value =
                    d.reflectivity;
            ...
            if (e.receiveShadow && !d._shadowPass && i.shadowMatrix) {
                c = T = 0;
                for (f = b.length; c < f; c++) if (j = b[c], j.castShadow && (j instanceof THREE.SpotLight || j instanceof THREE.DirectionalLight && !j.shadowCascade)) i.shadowMap.value[T] =
            ...
            b = d.uniformsList;
            i = 0;
            for (T = b.length; i < T; i++) if (f = g.uniforms[b[i][1]]) if (c = b[i][0], l = c.type, j = c.value, "i" === l) k.uniform1i(f, j); else if ("f" === l) k.uniform1f(f, j); else if ("v2" === l) k.uniform2f(f, j.x, j.y); else if ("v3" === l) k.uniform3f(f, j.x, j.y, j.z); else if ("v4" === l) k.uniform4f(f, j.x, j.y, j.z, j.w); else if ("c" === l) k.uniform3f(f, j.r, j.g,
                j.b); else if ("iv1" === l) k.uniform1iv(f, j); else if ("iv" === l) k.uniform3iv(f, j); else if ("fv1" === l) k.uniform1fv(f, j); else if ("fv" === l) k.uniform3fv(f, j); else if ("v2v" === l) {
            ...
            } else if ("m4" === l) void 0 === c._array && (c._array = new Float32Array(16)), j.flattenToArray(c._array), k.uniformMatrix4fv(f, !1, c._array); else if ("m4v" === l) {
                void 0 === c._array && (c._array = new Float32Array(16 * j.length));
                l = 0;
                for (n = j.length; l < n; l++) j[l].flattenToArrayOffset(c._array, 16 *
                    l);
                ...
                if (m = j, j = E(), k.uniform1i(f, j), m) if (m.image instanceof Array && 6 === m.image.length) {
                    if (c = m, f = j, 6 === c.image.length) if (c.needsUpdate) {
                        ...
                        j = [];
                        for (l = 0; 6 > l; l++) L.autoScaleCubemaps && !f ? (n = j, m = l, r = c.image[l], t =
                            Qc, r.width <= t && r.height <= t || (w = Math.max(r.width, r.height), q = Math.floor(r.width * t / w), t = Math.floor(r.height * t / w), w = document.createElement("canvas"), w.width = q, w.height = t, w.getContext("2d").drawImage(r, 0, 0, r.width, r.height, 0, 0, q, t), r = w), n[m] = r) : j[l] = c.image[l];
                        l = j[0];
                        ...
                        for (l = 0; 6 > l; l++) if (f) {
                            t = j[l].mipmaps;
                            w = 0;
                            for (z = t.length; w < z; w++) q = t[w], k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, w, m, q.width,
                                q.height, 0, q.data)
                        } else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, 0, m, m, r, j[l]);
                ...
                l = 0;
                for (n = c.value.length; l <
                n; l++) c._array[l] = E();
                k.uniform1iv(f, c._array);
                l = 0;
                for (n = c.value.length; l < n; l++) m = c.value[l], j = c._array[l], m && L.setTexture(m, j)
            }
    ...
    function E() {
        var a = Aa;
        a >= xc && console.warn("Trying to use " + a + " texture units while this GPU supports only " + xc);
        Aa += 1;
        return a
    }
    ...
    function D(a, b, c) {
        jb !== a && (a ? k.enable(k.POLYGON_OFFSET_FILL) : k.disable(k.POLYGON_OFFSET_FILL), jb = a);
    ...
    function G(a, b) {
        ...
        k.shaderSource(c,
            b);
        k.compileShader(c);
        return !k.getShaderParameter(c, k.COMPILE_STATUS) ? (console.error(k.getShaderInfoLog(c)), console.error(C(b)), null) : c
    }
    ...
    function P(a, b, c) {
        c ? (k.texParameteri(a, k.TEXTURE_WRAP_S, H(b.wrapS)), k.texParameteri(a, k.TEXTURE_WRAP_T, H(b.wrapT)), k.texParameteri(a, k.TEXTURE_MAG_FILTER, H(b.magFilter)), k.texParameteri(a, k.TEXTURE_MIN_FILTER, H(b.minFilter))) : (k.texParameteri(a, k.TEXTURE_WRAP_S, k.CLAMP_TO_EDGE), k.texParameteri(a, k.TEXTURE_WRAP_T, k.CLAMP_TO_EDGE), k.texParameteri(a, k.TEXTURE_MAG_FILTER,
            K(b.magFilter)), k.texParameteri(a, k.TEXTURE_MIN_FILTER, K(b.minFilter)));
        if (zb && b.type !== THREE.FloatType && (1 < b.anisotropy || b.__oldAnisotropy)) k.texParameterf(a, zb.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, oc)), b.__oldAnisotropy = b.anisotropy
    }

    function B(a, b) {
        k.bindRenderbuffer(k.RENDERBUFFER, a);
        b.depthBuffer && !b.stencilBuffer ? (k.renderbufferStorage(k.RENDERBUFFER, k.DEPTH_COMPONENT16, b.width, b.height), k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_ATTACHMENT, k.RENDERBUFFER, a)) : b.depthBuffer &&
    ...
    function H(a) {
        ...
        if (void 0 !== qb) {
            if (a === THREE.RGB_S3TC_DXT1_Format) return qb.COMPRESSED_RGB_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT1_Format) return qb.COMPRESSED_RGBA_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT3_Format) return qb.COMPRESSED_RGBA_S3TC_DXT3_EXT;
            if (a === THREE.RGBA_S3TC_DXT5_Format) return qb.COMPRESSED_RGBA_S3TC_DXT5_EXT
        }
        return 0
    }

    console.log("THREE.WebGLRenderer", THREE.REVISION);
    var a = a || {}, I = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"),
        N = void 0 !== a.precision ? a.precision : "highp", O = void 0 !== a.alpha ? a.alpha : !0,
        R = void 0 !== a.premultipliedAlpha ? a.premultipliedAlpha : !0, ga = void 0 !== a.antialias ? a.antialias : !1,
        M = void 0 !== a.stencil ? a.stencil : !0,
        J = void 0 !== a.preserveDrawingBuffer ? a.preserveDrawingBuffer : !1,
        Q = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0),
    ...
    this.info =
        {memory: {programs: 0, geometries: 0, textures: 0}, render: {calls: 0, vertices: 0, faces: 0, points: 0}};
    var L = this, oa = [], X = 0, fa = null, ca = null, Y = -1, ba = null, aa = null, ia = 0, Aa = 0, Na = -1, Ja = -1,
        ma = -1, sa = -1, Ea = -1, rb = -1, ib = -1, ob = -1, jb = null, Bb = null, Cb = null, Wa = null, Sa = 0,
        Ka = 0, kb = 0, Oa = 0, lb = 0, ab = 0, va = new THREE.Frustum, eb = new THREE.Matrix4, pb = new THREE.Matrix4,
        bb = new THREE.Vector4, xa = new THREE.Vector3, mb = !0, sb = {
            ambient: [0, 0, 0],
    ...
    try {
        if (!(k = I.getContext("experimental-webgl", {
            alpha: O,
    ...
    zb = k.getExtension("EXT_texture_filter_anisotropic") || k.getExtension("MOZ_EXT_texture_filter_anisotropic") ||
        k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
    qb = k.getExtension("WEBGL_compressed_texture_s3tc") || k.getExtension("MOZ_WEBGL_compressed_texture_s3tc") || k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");
    ...
    zb || console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");
    qb || console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");
    ...
    this.context = k;
    var xc = k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS), O = k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);
    ...
    this.clearTarget = function (a, b, c,
                                 d) {
    ...
    this.deallocateObject = function (a) {
        if (a.__webglInit) if (a.__webglInit = !1, delete a._modelViewMatrix, delete a._normalMatrix, delete a._normalMatrixArray, delete a._modelViewMatrixArray, delete a._modelMatrixArray, a instanceof THREE.Mesh) for (var c in a.geometry.geometryGroups) {
            ...
            if (d.numMorphTargets) {
                e = 0;
                for (f = d.numMorphTargets; e < f; e++) k.deleteBuffer(d.__webglMorphTargetsBuffers[e])
            }
    ...
    this.deallocateTexture = function (a) {
        a.__webglInit && (a.__webglInit = !1, k.deleteTexture(a.__webglTexture), L.info.memory.textures--)
    };
    ...
    this.deallocateMaterial = function (a) {
        ...
        if (b) {
            a.program = void 0;
            var c, d, e = !1, a = 0;
            for (c = oa.length; a < c; a++) if (d = oa[a], d.program === b) {
                d.usedTimes--;
                0 === d.usedTimes && (e = !0);
                break
            }
            if (e) {
                e = [];
                a = 0;
                for (c = oa.length; a < c; a++) d = oa[a], d.program !== b && e.push(d);
                oa = e;
                k.deleteProgram(b);
    ...
    this.renderBufferImmediate = function (a, b, c) {
        ...
        a.hasPositions && (k.bindBuffer(k.ARRAY_BUFFER, a.__webglVertexBuffer), k.bufferData(k.ARRAY_BUFFER, a.positionArray, k.DYNAMIC_DRAW), k.enableVertexAttribArray(b.attributes.position),
        ...
        a.hasColors && c.vertexColors !== THREE.NoColors && (k.bindBuffer(k.ARRAY_BUFFER, a.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, a.colorArray, k.DYNAMIC_DRAW), k.enableVertexAttribArray(b.attributes.color), k.vertexAttribPointer(b.attributes.color,
            3, k.FLOAT, !1, 0, 0));
        ...
        if (!1 !== d.visible) if (c = q(a, b, c, d, f), a = c.attributes, b = !1, d = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0), d !== ba && (ba = d, b = !0), f instanceof THREE.Mesh) {
            ...
            for (c = f.length; d < c; ++d) {
                ...
                if (b) {
                    ...
                    0 <= a.normal &&
                    h && (i = h.itemSize, k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.vertexAttribPointer(a.normal, i, k.FLOAT, !1, 0, 4 * g * i));
                    h = e.attributes.uv;
                    ...
                    0 <= a.tangent && h &&
                    (i = h.itemSize, k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.vertexAttribPointer(a.tangent, i, k.FLOAT, !1, 0, 4 * g * i));
    ...
    this.renderBuffer = function (a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            var g, h, c = q(a, b, c, d, f), b = c.attributes, a = !1,
                c = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0);
            c !== ba && (ba = c, a = !0);
            if (!d.morphTargets && 0 <= b.position) a && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), k.vertexAttribPointer(b.position,
                3, k.FLOAT, !1, 0, 0)); else if (f.morphTargetBase) {
                c = d.program.attributes;
                -1 !== f.morphTargetBase ? (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[f.morphTargetBase]), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0)) : 0 <= c.position && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0));
                if (f.morphTargetForcedOrder.length) {
                    var i = 0;
                    h = f.morphTargetForcedOrder;
                    for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length;) k.bindBuffer(k.ARRAY_BUFFER,
            ...
            if (a) {
                ...
                0 <= b.color && (k.bindBuffer(k.ARRAY_BUFFER,
                    e.__webglColorBuffer), k.vertexAttribPointer(b.color, 3, k.FLOAT, !1, 0, 0));
                0 <= b.normal && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglNormalBuffer), k.vertexAttribPointer(b.normal, 3, k.FLOAT, !1, 0, 0));
                0 <= b.tangent && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglTangentBuffer), k.vertexAttribPointer(b.tangent, 4, k.FLOAT, !1, 0, 0));
                ...
                0 <= b.uv2 &&
                (e.__webglUV2Buffer ? (k.bindBuffer(k.ARRAY_BUFFER, e.__webglUV2Buffer), k.vertexAttribPointer(b.uv2, 2, k.FLOAT, !1, 0, 0), k.enableVertexAttribArray(b.uv2)) : k.disableVertexAttribArray(b.uv2));
                d.skinning && (0 <= b.skinIndex && 0 <= b.skinWeight) && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglSkinIndicesBuffer), k.vertexAttribPointer(b.skinIndex, 4, k.FLOAT, !1, 0, 0), k.bindBuffer(k.ARRAY_BUFFER, e.__webglSkinWeightsBuffer), k.vertexAttribPointer(b.skinWeight, 4, k.FLOAT, !1, 0, 0));
                0 <= b.lineDistance && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglLineDistanceBuffer),
    ...
    this.render = function (a, b, c, d) {
        if (!1 === b instanceof THREE.Camera) console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            var e, f, g, h, i = a.__lights, j = a.fog;
            Y = -1;
            mb = !0;
            ...
            h = a.__webglObjects;
            d = 0;
            for (e = h.length; d < e; d++) if (f = h[d], g = f.object, f.render = !1, g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || va.contains(g))) {
                A(g, b);
                var m = f, s = m.buffer,
                    r = void 0, q = r = void 0, q = m.object.material;
                if (q instanceof THREE.MeshFaceMaterial) r = s.materialIndex, 0 <= r && (r = q.materials[r], r.transparent ? (m.transparent = r, m.opaque = null) : (m.opaque = r, m.transparent = null)); else if (r = q) r.transparent ? (m.transparent = r, m.opaque = null) : (m.opaque = r, m.transparent = null);
                f.render = !0;
                !0 === this.sortObjects && (null !== g.renderDepth ? f.z = g.renderDepth : (bb.copy(g.matrixWorld.getPosition()), eb.multiplyVector3(bb), f.z = bb.z), f.id = g.id)
            }
            this.sortObjects && h.sort(l);
            h = a.__webglObjectsImmediate;
            d = 0;
            for (e = h.length; d < e; d++) f = h[d], g = f.object, g.visible && (A(g, b), g = f.object.material, g.transparent ? (f.transparent = g, f.opaque = null) : (f.opaque = g, f.transparent = null));
            a.overrideMaterial ? (d = a.overrideMaterial, this.setBlending(d.blending, d.blendEquation, d.blendSrc, d.blendDst), this.setDepthTest(d.depthTest), this.setDepthWrite(d.depthWrite), D(d.polygonOffset, d.polygonOffsetFactor, d.polygonOffsetUnits), p(a.__webglObjects, !1, "", b, i, j, !0, d), o(a.__webglObjectsImmediate, "", b, i, j, !1, d)) : (this.setBlending(THREE.NormalBlending),
                p(a.__webglObjects, !0, "opaque", b, i, j, !1), o(a.__webglObjectsImmediate, "opaque", b, i, j, !1), p(a.__webglObjects, !1, "transparent", b, i, j, !0), o(a.__webglObjectsImmediate, "transparent", b, i, j, !0));
            n(this.renderPluginsPost, a, b);
            c && (c.generateMipmaps && c.minFilter !== THREE.NearestFilter && c.minFilter !== THREE.LinearFilter) && (c instanceof THREE.WebGLRenderTargetCube ? (k.bindTexture(k.TEXTURE_CUBE_MAP, c.__webglTexture), k.generateMipmap(k.TEXTURE_CUBE_MAP), k.bindTexture(k.TEXTURE_CUBE_MAP, null)) : (k.bindTexture(k.TEXTURE_2D,
                c.__webglTexture), k.generateMipmap(k.TEXTURE_2D), k.bindTexture(k.TEXTURE_2D, null)));
            this.setDepthTest(!0);
    ...
    this.renderImmediateObject = function (a, b, c, d, e) {
        ...
        e.immediateRenderCallback ? e.immediateRenderCallback(f, k, va) : e.render(function (a) {
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsAdded.length;) {
            var b =
                a.__objectsAdded[0], l = a, n = void 0, m = void 0, o = void 0, p = void 0;
            if (!b.__webglInit) if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, b instanceof THREE.Mesh) if (m = b.geometry, o = b.material, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    var q = m, u = void 0, v = void 0, A = void 0, B = void 0, C = void 0, D = void 0, E = void 0,
                        G = {}, H = q.morphTargets.length, I = q.morphNormals.length,
                        X = o instanceof THREE.MeshFaceMaterial;
                    q.geometryGroups = {};
                    u = 0;
                    for (v = q.faces.length; u < v; u++) A = q.faces[u],
                        B = X ? A.materialIndex : void 0, D = void 0 !== B ? B : -1, void 0 === G[D] && (G[D] = {
                        hash: D,
                        counter: 0
                    }), E = G[D].hash + "_" + G[D].counter, void 0 === q.geometryGroups[E] && (q.geometryGroups[E] = {
                        faces3: [],
                        faces4: [],
                        materialIndex: B,
                        vertices: 0,
                        numMorphTargets: H,
                        numMorphNormals: I
                    }), C = A instanceof THREE.Face3 ? 3 : 4, 65535 < q.geometryGroups[E].vertices + C && (G[D].counter += 1, E = G[D].hash + "_" + G[D].counter, void 0 === q.geometryGroups[E] && (q.geometryGroups[E] = {
                        faces3: [],
                        faces4: [],
                        materialIndex: B,
                        vertices: 0,
                        ...
                        A instanceof THREE.Face3 ? q.geometryGroups[E].faces3.push(u) : q.geometryGroups[E].faces4.push(u), q.geometryGroups[E].vertices += C;
                    q.geometryGroupsList = [];
                    var Y = void 0;
                    for (Y in q.geometryGroups) q.geometryGroups[Y].id = ia++, q.geometryGroupsList.push(q.geometryGroups[Y])
                }
                for (n in m.geometryGroups) if (p = m.geometryGroups[n], !p.__webglVertexBuffer) {
                    ...
                    var K = void 0, Q = void 0;
                    if (J.numMorphTargets) {
                        J.__webglMorphTargetsBuffers = [];
                        K = 0;
                        for (Q = J.numMorphTargets; K < Q; K++) J.__webglMorphTargetsBuffers.push(k.createBuffer())
                    }
                    if (J.numMorphNormals) {
                        J.__webglMorphNormalsBuffers = [];
                        K = 0;
                        for (Q = J.numMorphNormals; K < Q; K++) J.__webglMorphNormalsBuffers.push(k.createBuffer())
                    }
                    L.info.memory.geometries++;
                    d(p, b);
                ...
                if (m = b.geometry, !m.__webglVertexBuffer) {
                    ...
                    L.info.memory.geometries++;
                    var M = m, P = b, N = M.vertices.length;
                    M.__vertexArray = new Float32Array(3 *
                        N);
                ...
                if (m = b.geometry, !m.__webglVertexBuffer) {
                    ...
                    L.info.memory.geometries++;
                    var fa = m, R = b, Z = fa.vertices.length;
                    fa.__vertexArray = new Float32Array(3 * Z);
                    fa.__colorArray =
                        new Float32Array(3 * Z);
                ...
                L.info.memory.geometries++;
                var ba = m, ga = b, Aa = ba.vertices.length;
                ba.__vertexArray = new Float32Array(3 * Aa);
                ba.__colorArray = new Float32Array(3 *
                    Aa);
                ba.__sortArray = [];
            ...
            if (!b.__webglActive) {
                ...
                b.immediateRenderCallback ? l.__webglObjectsImmediate.push({
                    object: b,
                    opaque: null,
                    transparent: null
                }) : b instanceof THREE.Sprite ? l.__webglSprites.push(b) : b instanceof THREE.LensFlare && l.__webglFlares.push(b);
                b.__webglActive = !0
            }
            a.__objectsAdded.splice(0, 1)
        }
        for (; a.__objectsRemoved.length;) {
            var oa = a.__objectsRemoved[0], sa = a;
            oa instanceof THREE.Mesh || oa instanceof THREE.ParticleSystem || oa instanceof THREE.Ribbon || oa instanceof THREE.Line ? z(sa.__webglObjects, oa) : oa instanceof THREE.Sprite ? w(sa.__webglSprites,
                oa) : oa instanceof THREE.LensFlare ? w(sa.__webglFlares, oa) : (oa instanceof THREE.ImmediateRenderObject || oa.immediateRenderCallback) && z(sa.__webglObjectsImmediate, oa);
            oa.__webglActive = !1;
            a.__objectsRemoved.splice(0, 1)
        }
        for (var Na = 0, xa = a.__webglObjects.length; Na < xa; Na++) {
            var qa = a.__webglObjects[Na].object, T = qa.geometry, Ja = void 0, va = void 0, ma = void 0;
            if (qa instanceof THREE.Mesh) if (T instanceof THREE.BufferGeometry) (T.verticesNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate ||
                ...
                for (var Ka = 0, Oa = T.geometryGroupsList.length; Ka < Oa; Ka++) if (Ja = T.geometryGroupsList[Ka], ma = e(qa, Ja), T.buffersNeedUpdate && d(Ja, qa), va = ma.attributes && t(ma), T.verticesNeedUpdate || T.morphTargetsNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate || T.tangentsNeedUpdate || va) {
                    var ra =
                        Ja, Sa = qa, Ea = k.DYNAMIC_DRAW, ib = !T.dynamic, Wa = ma;
                    if (ra.__inittedArrays) {
                        var mb = f(Wa), rb = Wa.vertexColors ? Wa.vertexColors : !1, ob = g(Wa),
                            lb = mb === THREE.SmoothShading, F = void 0, $ = void 0, ab = void 0, S = void 0,
                            eb = void 0, bb = void 0, Eb = void 0, pb = void 0, Vb = void 0, jb = void 0, kb = void 0,
                            U = void 0, V = void 0, W = void 0, pa = void 0, Fb = void 0, Gb = void 0, Hb = void 0,
                            qb = void 0, Ib = void 0, Jb = void 0, Kb = void 0, sb = void 0, Lb = void 0, Mb = void 0,
                            Nb = void 0, zb = void 0, Ob = void 0, Pb = void 0, Qb = void 0, Bb = void 0, Rb = void 0,
                            Sb = void 0, Tb = void 0, Cb = void 0,
                            wa = void 0, gc = void 0, ac = void 0, kc = void 0, lc = void 0, Ta = void 0, hc = void 0,
                            Qa = void 0, Ra = void 0, bc = void 0, Wb = void 0, La = 0, Pa = 0, Xb = 0, Yb = 0, vb = 0,
                            Za = 0, Ba = 0, db = 0, Ma = 0, ha = 0, ja = 0, y = 0, ya = void 0, Ua = ra.__vertexArray,
                            pc = ra.__uvArray, qc = ra.__uv2Array, wb = ra.__normalArray, Fa = ra.__tangentArray,
                            Va = ra.__colorArray, Ga = ra.__skinIndexArray, Ha = ra.__skinWeightArray,
                            Sc = ra.__morphTargetsArrays, Tc = ra.__morphNormalsArrays,
                            Uc = ra.__webglCustomAttributesList, x = void 0, Ub = ra.__faceArray, nb = ra.__lineArray,
                            fb = Sa.geometry, xc = fb.elementsNeedUpdate,
                            oc = fb.uvsNeedUpdate, Pc = fb.normalsNeedUpdate, Qc = fb.tangentsNeedUpdate,
                            hd = fb.colorsNeedUpdate, id = fb.morphTargetsNeedUpdate, ec = fb.vertices, ta = ra.faces3,
                            ua = ra.faces4, $a = fb.faces, Vc = fb.faceVertexUvs[0], Wc = fb.faceVertexUvs[1],
                            fc = fb.skinIndices, cc = fb.skinWeights, dc = fb.morphTargets, Ac = fb.morphNormals;
                        if (fb.verticesNeedUpdate) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) S = $a[ta[F]], U = ec[S.a], V = ec[S.b], W = ec[S.c], Ua[Pa] = U.x, Ua[Pa + 1] = U.y, Ua[Pa + 2] = U.z, Ua[Pa + 3] = V.x, Ua[Pa + 4] = V.y, Ua[Pa + 5] = V.z, Ua[Pa + 6] = W.x, Ua[Pa + 7] = W.y, Ua[Pa + 8] =
                                W.z, Pa += 9;
                            F = 0;
                            for ($ = ua.length; F < $; F++) S = $a[ua[F]], U = ec[S.a], V = ec[S.b], W = ec[S.c], pa = ec[S.d], Ua[Pa] = U.x, Ua[Pa + 1] = U.y, Ua[Pa + 2] = U.z, Ua[Pa + 3] = V.x, Ua[Pa + 4] = V.y, Ua[Pa + 5] = V.z, Ua[Pa + 6] = W.x, Ua[Pa + 7] = W.y, Ua[Pa + 8] = W.z, Ua[Pa + 9] = pa.x, Ua[Pa + 10] = pa.y, Ua[Pa + 11] = pa.z, Pa += 12;
                        ...
                        if (id) {
                            ...
                            for (hc = dc.length; Ta < hc; Ta++) {
                                F = ja = 0;
                                for ($ = ta.length; F < $; F++) bc = ta[F], S = $a[bc], U = dc[Ta].vertices[S.a], V = dc[Ta].vertices[S.b], W = dc[Ta].vertices[S.c],
                                ...
                                F = 0;
                                for ($ = ua.length; F < $; F++) bc = ua[F], S = $a[bc], U = dc[Ta].vertices[S.a], V = dc[Ta].vertices[S.b], W = dc[Ta].vertices[S.c], pa = dc[Ta].vertices[S.d],
                                ...
                                Wa.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, ra.__webglMorphNormalsBuffers[Ta]), k.bufferData(k.ARRAY_BUFFER, Tc[Ta], Ea))
                            }
                        }
                        if (cc.length) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) S = $a[ta[F]], Ob = cc[S.a], Pb = cc[S.b], Qb = cc[S.c], Ha[ha] = Ob.x, Ha[ha + 1] = Ob.y, Ha[ha + 2] = Ob.z, Ha[ha + 3] = Ob.w, Ha[ha + 4] = Pb.x, Ha[ha + 5] = Pb.y, Ha[ha + 6] = Pb.z, Ha[ha + 7] = Pb.w, Ha[ha + 8] = Qb.x, Ha[ha + 9] = Qb.y, Ha[ha + 10] = Qb.z, Ha[ha + 11] = Qb.w, Rb = fc[S.a], Sb = fc[S.b], Tb = fc[S.c], Ga[ha] = Rb.x, Ga[ha +
                            1] = Rb.y, Ga[ha + 2] = Rb.z, Ga[ha + 3] = Rb.w, Ga[ha + 4] = Sb.x, Ga[ha + 5] = Sb.y, Ga[ha + 6] = Sb.z, Ga[ha + 7] = Sb.w, Ga[ha + 8] = Tb.x, Ga[ha + 9] = Tb.y, Ga[ha + 10] = Tb.z, Ga[ha + 11] = Tb.w, ha += 12;
                            F = 0;
                            for ($ = ua.length; F < $; F++) S = $a[ua[F]], Ob = cc[S.a], Pb = cc[S.b], Qb = cc[S.c], Bb = cc[S.d], Ha[ha] = Ob.x, Ha[ha + 1] = Ob.y, Ha[ha + 2] = Ob.z, Ha[ha + 3] = Ob.w, Ha[ha + 4] = Pb.x, Ha[ha + 5] = Pb.y, Ha[ha + 6] = Pb.z, Ha[ha + 7] = Pb.w, Ha[ha + 8] = Qb.x, Ha[ha + 9] = Qb.y, Ha[ha + 10] = Qb.z, Ha[ha + 11] = Qb.w, Ha[ha + 12] = Bb.x, Ha[ha + 13] = Bb.y, Ha[ha + 14] = Bb.z, Ha[ha + 15] = Bb.w, Rb = fc[S.a], Sb = fc[S.b], Tb = fc[S.c],
                                Cb = fc[S.d], Ga[ha] = Rb.x, Ga[ha + 1] = Rb.y, Ga[ha + 2] = Rb.z, Ga[ha + 3] = Rb.w, Ga[ha + 4] = Sb.x, Ga[ha + 5] = Sb.y, Ga[ha + 6] = Sb.z, Ga[ha + 7] = Sb.w, Ga[ha + 8] = Tb.x, Ga[ha + 9] = Tb.y, Ga[ha + 10] = Tb.z, Ga[ha + 11] = Tb.w, Ga[ha + 12] = Cb.x, Ga[ha + 13] = Cb.y, Ga[ha + 14] = Cb.z, Ga[ha + 15] = Cb.w, ha += 16;
                            0 < ha && (k.bindBuffer(k.ARRAY_BUFFER, ra.__webglSkinIndicesBuffer), k.bufferData(k.ARRAY_BUFFER, Ga, Ea), k.bindBuffer(k.ARRAY_BUFFER, ra.__webglSkinWeightsBuffer), k.bufferData(k.ARRAY_BUFFER, Ha, Ea))
                        }
                        if (hd && rb) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) S = $a[ta[F]], Eb = S.vertexColors,
                                pb = S.color, 3 === Eb.length && rb === THREE.VertexColors ? (Lb = Eb[0], Mb = Eb[1], Nb = Eb[2]) : Nb = Mb = Lb = pb, Va[Ma] = Lb.r, Va[Ma + 1] = Lb.g, Va[Ma + 2] = Lb.b, Va[Ma + 3] = Mb.r, Va[Ma + 4] = Mb.g, Va[Ma + 5] = Mb.b, Va[Ma + 6] = Nb.r, Va[Ma + 7] = Nb.g, Va[Ma + 8] = Nb.b, Ma += 9;
                            F = 0;
                            for ($ = ua.length; F < $; F++) S = $a[ua[F]], Eb = S.vertexColors, pb = S.color, 4 === Eb.length && rb === THREE.VertexColors ? (Lb = Eb[0], Mb = Eb[1], Nb = Eb[2], zb = Eb[3]) : zb = Nb = Mb = Lb = pb, Va[Ma] = Lb.r, Va[Ma + 1] = Lb.g, Va[Ma + 2] = Lb.b, Va[Ma + 3] = Mb.r, Va[Ma + 4] = Mb.g, Va[Ma + 5] = Mb.b, Va[Ma + 6] = Nb.r, Va[Ma + 7] = Nb.g, Va[Ma + 8] =
                                Nb.b, Va[Ma + 9] = zb.r, Va[Ma + 10] = zb.g, Va[Ma + 11] = zb.b, Ma += 12;
                            0 < Ma && (k.bindBuffer(k.ARRAY_BUFFER, ra.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, Va, Ea))
                        }
                        if (Qc && fb.hasTangents) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) S = $a[ta[F]], Vb = S.vertexTangents, Fb = Vb[0], Gb = Vb[1], Hb = Vb[2], Fa[Ba] = Fb.x, Fa[Ba + 1] = Fb.y, Fa[Ba + 2] = Fb.z, Fa[Ba + 3] = Fb.w, Fa[Ba + 4] = Gb.x, Fa[Ba + 5] = Gb.y, Fa[Ba + 6] = Gb.z, Fa[Ba + 7] = Gb.w, Fa[Ba + 8] = Hb.x, Fa[Ba + 9] = Hb.y, Fa[Ba + 10] = Hb.z, Fa[Ba + 11] = Hb.w, Ba += 12;
                            F = 0;
                            for ($ = ua.length; F < $; F++) S = $a[ua[F]], Vb = S.vertexTangents, Fb = Vb[0],
                                Gb = Vb[1], Hb = Vb[2], qb = Vb[3], Fa[Ba] = Fb.x, Fa[Ba + 1] = Fb.y, Fa[Ba + 2] = Fb.z, Fa[Ba + 3] = Fb.w, Fa[Ba + 4] = Gb.x, Fa[Ba + 5] = Gb.y, Fa[Ba + 6] = Gb.z, Fa[Ba + 7] = Gb.w, Fa[Ba + 8] = Hb.x, Fa[Ba + 9] = Hb.y, Fa[Ba + 10] = Hb.z, Fa[Ba + 11] = Hb.w, Fa[Ba + 12] = qb.x, Fa[Ba + 13] = qb.y, Fa[Ba + 14] = qb.z, Fa[Ba + 15] = qb.w, Ba += 16;
                            k.bindBuffer(k.ARRAY_BUFFER, ra.__webglTangentBuffer);
                            k.bufferData(k.ARRAY_BUFFER, Fa, Ea)
                        }
                        if (Pc && mb) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) if (S = $a[ta[F]], eb = S.vertexNormals, bb = S.normal, 3 === eb.length && lb) for (wa = 0; 3 > wa; wa++) ac = eb[wa], wb[Za] = ac.x, wb[Za + 1] =
                                ac.y, wb[Za + 2] = ac.z, Za += 3; else for (wa = 0; 3 > wa; wa++) wb[Za] = bb.x, wb[Za + 1] = bb.y, wb[Za + 2] = bb.z, Za += 3;
                            F = 0;
                            for ($ = ua.length; F < $; F++) if (S = $a[ua[F]], eb = S.vertexNormals, bb = S.normal, 4 === eb.length && lb) for (wa = 0; 4 > wa; wa++) ac = eb[wa], wb[Za] = ac.x, wb[Za + 1] = ac.y, wb[Za + 2] = ac.z, Za += 3; else for (wa = 0; 4 > wa; wa++) wb[Za] = bb.x, wb[Za + 1] = bb.y, wb[Za + 2] = bb.z, Za += 3;
                            k.bindBuffer(k.ARRAY_BUFFER, ra.__webglNormalBuffer);
                            k.bufferData(k.ARRAY_BUFFER, wb, Ea)
                        }
                        if (oc && Vc && ob) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) if (ab = ta[F], jb = Vc[ab], void 0 !== jb) for (wa =
                                                                                                                 0; 3 > wa; wa++) kc = jb[wa], pc[Xb] = kc.u, pc[Xb + 1] = kc.v, Xb += 2;
                            F = 0;
                            for ($ = ua.length; F < $; F++) if (ab = ua[F], jb = Vc[ab], void 0 !== jb) for (wa = 0; 4 > wa; wa++) kc = jb[wa], pc[Xb] = kc.u, pc[Xb + 1] = kc.v, Xb += 2;
                            0 < Xb && (k.bindBuffer(k.ARRAY_BUFFER, ra.__webglUVBuffer), k.bufferData(k.ARRAY_BUFFER, pc, Ea))
                        }
                        if (oc && Wc && ob) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) if (ab = ta[F], kb = Wc[ab], void 0 !== kb) for (wa = 0; 3 > wa; wa++) lc = kb[wa], qc[Yb] = lc.u, qc[Yb + 1] = lc.v, Yb += 2;
                            F = 0;
                            for ($ = ua.length; F < $; F++) if (ab = ua[F], kb = Wc[ab], void 0 !== kb) for (wa = 0; 4 > wa; wa++) lc = kb[wa], qc[Yb] =
                                lc.u, qc[Yb + 1] = lc.v, Yb += 2;
                            0 < Yb && (k.bindBuffer(k.ARRAY_BUFFER, ra.__webglUV2Buffer), k.bufferData(k.ARRAY_BUFFER, qc, Ea))
                        }
                        if (xc) {
                            F = 0;
                            for ($ = ta.length; F < $; F++) Ub[vb] = La, Ub[vb + 1] = La + 1, Ub[vb + 2] = La + 2, vb += 3, nb[db] = La, nb[db + 1] = La + 1, nb[db + 2] = La, nb[db + 3] = La + 2, nb[db + 4] = La + 1, nb[db + 5] = La + 2, db += 6, La += 3;
                            F = 0;
                            for ($ = ua.length; F < $; F++) Ub[vb] = La, Ub[vb + 1] = La + 1, Ub[vb + 2] = La + 3, Ub[vb + 3] = La + 1, Ub[vb + 4] = La + 2, Ub[vb + 5] = La + 3, vb += 6, nb[db] = La, nb[db + 1] = La + 1, nb[db + 2] = La, nb[db + 3] = La + 3, nb[db + 4] = La + 1, nb[db + 5] = La + 2, nb[db + 6] = La + 2, nb[db + 7] =
                                La + 3, db += 8, La += 4;
                        ...
                        if (Uc) {
                            wa = 0;
                            for (gc = Uc.length; wa < gc; wa++) if (x = Uc[wa], x.__original.needsUpdate) {
                                y = 0;
                                if (1 === x.size) if (void 0 === x.boundTo || "vertices" === x.boundTo) {
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) S = $a[ta[F]], x.array[y] = x.value[S.a], x.array[y + 1] = x.value[S.b], x.array[y + 2] = x.value[S.c], y += 3;
                                    F = 0;
                                    for ($ = ua.length; F <
                                    ...
                                    if ("faces" === x.boundTo) {
                                        F = 0;
                                        for ($ = ta.length; F < $; F++) ya = x.value[ta[F]], x.array[y] = ya, x.array[y + 1] = ya, x.array[y + 2] = ya, y += 3;
                                        F = 0;
                                        for ($ = ua.length; F < $; F++) ya = x.value[ua[F]], x.array[y] = ya, x.array[y + 1] = ya, x.array[y + 2] = ya, x.array[y + 3] = ya, y += 4
                                    }
                                } else if (2 === x.size) if (void 0 === x.boundTo || "vertices" === x.boundTo) {
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) S = $a[ta[F]], U = x.value[S.a], V = x.value[S.b],
                                        W = x.value[S.c], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = V.x, x.array[y + 3] = V.y, x.array[y + 4] = W.x, x.array[y + 5] = W.y, y += 6;
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) S = $a[ua[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], pa = x.value[S.d], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = V.x, x.array[y + 3] = V.y, x.array[y + 4] = W.x, x.array[y + 5] = W.y, x.array[y + 6] = pa.x, x.array[y + 7] = pa.y, y += 8
                                } else {
                                    if ("faces" === x.boundTo) {
                                        F = 0;
                                        for ($ = ta.length; F < $; F++) W = V = U = ya = x.value[ta[F]], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = V.x, x.array[y +
                                        3] = V.y, x.array[y + 4] = W.x, x.array[y + 5] = W.y, y += 6;
                                        F = 0;
                                        for ($ = ua.length; F < $; F++) pa = W = V = U = ya = x.value[ua[F]], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = V.x, x.array[y + 3] = V.y, x.array[y + 4] = W.x, x.array[y + 5] = W.y, x.array[y + 6] = pa.x, x.array[y + 7] = pa.y, y += 8
                                    }
                                } else if (3 === x.size) {
                                    var ea;
                                    ...
                                    if (void 0 === x.boundTo || "vertices" === x.boundTo) {
                                        F = 0;
                                        for ($ = ta.length; F < $; F++) S = $a[ta[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], x.array[y] = U[ea[0]], x.array[y + 1] = U[ea[1]], x.array[y + 2] =
                                            U[ea[2]], x.array[y + 3] = V[ea[0]], x.array[y + 4] = V[ea[1]], x.array[y + 5] = V[ea[2]], x.array[y + 6] = W[ea[0]], x.array[y + 7] = W[ea[1]], x.array[y + 8] = W[ea[2]], y += 9;
                                        F = 0;
                                        for ($ = ua.length; F < $; F++) S = $a[ua[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], pa = x.value[S.d], x.array[y] = U[ea[0]], x.array[y + 1] = U[ea[1]], x.array[y + 2] = U[ea[2]], x.array[y + 3] = V[ea[0]], x.array[y + 4] = V[ea[1]], x.array[y + 5] = V[ea[2]], x.array[y + 6] = W[ea[0]], x.array[y + 7] = W[ea[1]], x.array[y + 8] = W[ea[2]], x.array[y + 9] = pa[ea[0]], x.array[y + 10] = pa[ea[1]], x.array[y + 11] =
                                            pa[ea[2]], y += 12
                                    } else if ("faces" === x.boundTo) {
                                        F = 0;
                                        for ($ = ta.length; F < $; F++) W = V = U = ya = x.value[ta[F]], x.array[y] = U[ea[0]], x.array[y + 1] = U[ea[1]], x.array[y + 2] = U[ea[2]], x.array[y + 3] = V[ea[0]], x.array[y + 4] = V[ea[1]], x.array[y + 5] = V[ea[2]], x.array[y + 6] = W[ea[0]], x.array[y + 7] = W[ea[1]], x.array[y + 8] = W[ea[2]], y += 9;
                                        F = 0;
                                        for ($ = ua.length; F < $; F++) pa = W = V = U = ya = x.value[ua[F]], x.array[y] = U[ea[0]], x.array[y + 1] = U[ea[1]], x.array[y + 2] = U[ea[2]], x.array[y + 3] = V[ea[0]], x.array[y + 4] = V[ea[1]], x.array[y + 5] = V[ea[2]], x.array[y + 6] = W[ea[0]],
                                        ...
                                        F = 0;
                                        for ($ = ta.length; F < $; F++) ya = x.value[ta[F]], U = ya[0], V = ya[1], W = ya[2], x.array[y] = U[ea[0]], x.array[y + 1] = U[ea[1]], x.array[y + 2] = U[ea[2]], x.array[y + 3] = V[ea[0]], x.array[y + 4] = V[ea[1]], x.array[y + 5] = V[ea[2]], x.array[y + 6] = W[ea[0]], x.array[y + 7] = W[ea[1]], x.array[y + 8] = W[ea[2]], y += 9;
                                        F = 0;
                                        for ($ = ua.length; F < $; F++) ya = x.value[ua[F]], U = ya[0], V = ya[1], W = ya[2], pa =
                                    ...
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) S = $a[ta[F]], U = x.value[S.a], V = x.value[S.b], W = x.value[S.c], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y +
                                    4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, y += 12;
                                    F = 0;
                                    ...
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) W = V = U = ya = x.value[ta[F]], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, y += 12;
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) pa = W = V = U = ya = x.value[ua[F]], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y +
                                    ...
                                    F = 0;
                                    for ($ = ta.length; F < $; F++) ya = x.value[ta[F]], U = ya[0], V = ya[1], W = ya[2], x.array[y] = U.x, x.array[y + 1] = U.y, x.array[y + 2] = U.z, x.array[y + 3] = U.w, x.array[y + 4] = V.x, x.array[y + 5] = V.y, x.array[y + 6] = V.z, x.array[y + 7] = V.w, x.array[y + 8] = W.x, x.array[y + 9] = W.y, x.array[y + 10] = W.z, x.array[y + 11] = W.w, y += 12;
                                    F = 0;
                                    for ($ = ua.length; F < $; F++) ya = x.value[ua[F]],
                ...
                if (T.verticesNeedUpdate || T.colorsNeedUpdate || T.normalsNeedUpdate ||
                    va) {
                    var xb = T, Bc = k.DYNAMIC_DRAW, rc = void 0, sc = void 0, tc = void 0, Cc = void 0, za = void 0,
                        Dc = void 0, Ec = void 0, Fc = void 0, Zc = void 0, Xa = void 0, mc = void 0, Ca = void 0,
                        gb = void 0, $c = xb.vertices, ad = xb.colors, bd = xb.normals, jd = $c.length, kd = ad.length,
                        ld = bd.length, Gc = xb.__vertexArray, Hc = xb.__colorArray, Ic = xb.__normalArray,
                        md = xb.colorsNeedUpdate, nd = xb.normalsNeedUpdate, Xc = xb.__webglCustomAttributesList;
                    if (xb.verticesNeedUpdate) {
                        for (rc = 0; rc < jd; rc++) Cc = $c[rc], za = 3 * rc, Gc[za] = Cc.x, Gc[za + 1] = Cc.y, Gc[za + 2] = Cc.z;
                        k.bindBuffer(k.ARRAY_BUFFER,
                            xb.__webglVertexBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Gc, Bc)
                    }
                    if (md) {
                        for (sc = 0; sc < kd; sc++) Dc = ad[sc], za = 3 * sc, Hc[za] = Dc.r, Hc[za + 1] = Dc.g, Hc[za + 2] = Dc.b;
                        k.bindBuffer(k.ARRAY_BUFFER, xb.__webglColorBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Hc, Bc)
                    }
                    if (nd) {
                        for (tc = 0; tc < ld; tc++) Ec = bd[tc], za = 3 * tc, Ic[za] = Ec.x, Ic[za + 1] = Ec.y, Ic[za + 2] = Ec.z;
                        k.bindBuffer(k.ARRAY_BUFFER, xb.__webglNormalBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Ic, Bc)
                    }
                    if (Xc) {
                        Fc = 0;
                        for (Zc = Xc.length; Fc < Zc; Fc++) if (Ca = Xc[Fc], Ca.needsUpdate && (void 0 === Ca.boundTo || "vertices" ===
                            Ca.boundTo)) {
                            za = 0;
                            mc = Ca.value.length;
                            if (1 === Ca.size) for (Xa = 0; Xa < mc; Xa++) Ca.array[Xa] = Ca.value[Xa]; else if (2 === Ca.size) for (Xa = 0; Xa < mc; Xa++) gb = Ca.value[Xa], Ca.array[za] = gb.x, Ca.array[za + 1] = gb.y, za += 2; else if (3 === Ca.size) if ("c" === Ca.type) for (Xa = 0; Xa < mc; Xa++) gb = Ca.value[Xa], Ca.array[za] = gb.r, Ca.array[za + 1] = gb.g, Ca.array[za + 2] = gb.b, za += 3; else for (Xa = 0; Xa < mc; Xa++) gb = Ca.value[Xa], Ca.array[za] = gb.x, Ca.array[za + 1] = gb.y, Ca.array[za + 2] = gb.z, za += 3; else if (4 === Ca.size) for (Xa = 0; Xa < mc; Xa++) gb = Ca.value[Xa], Ca.array[za] =
                                gb.x, Ca.array[za + 1] = gb.y, Ca.array[za + 2] = gb.z, Ca.array[za + 3] = gb.w, za += 4;
                ...
                ma = e(qa, T);
                va = ma.attributes && t(ma);
                if (T.verticesNeedUpdate || T.colorsNeedUpdate || T.lineDistancesNeedUpdate || va) {
                    var yb = T, Jc = k.DYNAMIC_DRAW, uc = void 0, vc = void 0, wc = void 0, Kc = void 0, Ia = void 0,
                        Lc = void 0, cd = yb.vertices, dd = yb.colors,
                        ed = yb.lineDistances, od = cd.length, pd = dd.length, qd = ed.length, Mc = yb.__vertexArray,
                        Nc = yb.__colorArray, fd = yb.__lineDistanceArray, rd = yb.colorsNeedUpdate,
                        sd = yb.lineDistancesNeedUpdate, Yc = yb.__webglCustomAttributesList, Oc = void 0, gd = void 0,
                        Ya = void 0, nc = void 0, hb = void 0, Da = void 0;
                    if (yb.verticesNeedUpdate) {
                        for (uc = 0; uc < od; uc++) Kc = cd[uc], Ia = 3 * uc, Mc[Ia] = Kc.x, Mc[Ia + 1] = Kc.y, Mc[Ia + 2] = Kc.z;
                        k.bindBuffer(k.ARRAY_BUFFER, yb.__webglVertexBuffer);
                        k.bufferData(k.ARRAY_BUFFER, Mc, Jc)
                    }
                    if (rd) {
                        for (vc = 0; vc < pd; vc++) Lc = dd[vc], Ia =
                            3 * vc, Nc[Ia] = Lc.r, Nc[Ia + 1] = Lc.g, Nc[Ia + 2] = Lc.b;
                    ...
                    if (Yc) {
                        Oc = 0;
                        for (gd = Yc.length; Oc < gd; Oc++) if (Da = Yc[Oc], Da.needsUpdate && (void 0 === Da.boundTo || "vertices" === Da.boundTo)) {
                            Ia = 0;
                            nc = Da.value.length;
                            if (1 === Da.size) for (Ya = 0; Ya < nc; Ya++) Da.array[Ya] = Da.value[Ya]; else if (2 === Da.size) for (Ya = 0; Ya < nc; Ya++) hb =
                                Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Ia += 2; else if (3 === Da.size) if ("c" === Da.type) for (Ya = 0; Ya < nc; Ya++) hb = Da.value[Ya], Da.array[Ia] = hb.r, Da.array[Ia + 1] = hb.g, Da.array[Ia + 2] = hb.b, Ia += 3; else for (Ya = 0; Ya < nc; Ya++) hb = Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Da.array[Ia + 2] = hb.z, Ia += 3; else if (4 === Da.size) for (Ya = 0; Ya < nc; Ya++) hb = Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Da.array[Ia + 2] = hb.z, Da.array[Ia + 3] = hb.w, Ia += 4;
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        var p, s, r;
        e = p = s = r = o = 0;
        for (f = b.length; e < f; e++) g = b[e], g.onlyShadow || (g instanceof THREE.DirectionalLight && p++, g instanceof THREE.PointLight && s++, g instanceof THREE.SpotLight && r++, g instanceof THREE.HemisphereLight && o++);
        e = p;
        f = s;
        g = r;
        h = o;
        o = p = 0;
        for (r = b.length; o < r; o++) s = b[o], s.castShadow && (s instanceof THREE.SpotLight && p++, s instanceof THREE.DirectionalLight && !s.shadowCascade && p++);
        m = p;
        hc && d && d.useVertexTexture ? l = 1024 : (b = k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),
        ...
        a:{
            ...
            n = d.join();
            t = 0;
            for (u = oa.length; t < u; t++) if (d = oa[t], d.code === n) {
                d.usedTimes++;
                q = d.program;
                break a
            }
            ...
            w = t;
            t = 0;
            for (u = w.length; t < u; t++) d = w[t], v.uniforms[d] = k.getUniformLocation(v, d);
            ...
            q = t;
            w = 0;
            for (b = q.length; w < b; w++) t = q[w], v.attributes[t] = k.getAttribLocation(v, t);
            v.id = X++;
            oa.push({program: v, code: n, usedTimes: 1});
        ...
        a.skinning && (0 <= q.skinIndex && 0 <= q.skinWeight) && (k.enableVertexAttribArray(q.skinIndex), k.enableVertexAttribArray(q.skinWeight));
        if (a.attributes) for (j in a.attributes) void 0 !== q[j] && 0 <= q[j] && k.enableVertexAttribArray(q[j]);
        if (a.morphTargets) {
            a.numSupportedMorphTargets = 0;
            v = "morphTarget";
            for (j = 0; j < this.maxMorphTargets; j++) w = v + j, 0 <= q[w] && (k.enableVertexAttribArray(q[w]), a.numSupportedMorphTargets++)
        }
        if (a.morphNormals) {
    ...
    this.setMaterialFaces = function (a) {
        ...
        Na !== b && (b ? k.disable(k.CULL_FACE) :
            k.enable(k.CULL_FACE), Na = b);
    ...
    this.setTexture =
        function (a, b) {
            if (a.needsUpdate) {
                ...
                var c = a.image, d = 0 === (c.width & c.width - 1) && 0 === (c.height & c.height - 1), e = H(a.format),
                    f = H(a.type);
                P(k.TEXTURE_2D, a, d);
                if (a instanceof THREE.CompressedTexture) for (var f = a.mipmaps, g = 0, h = f.length; g <
                h; g++) c = f[g], k.compressedTexImage2D(k.TEXTURE_2D, g, e, c.width, c.height, 0, c.data); else a instanceof THREE.DataTexture ? k.texImage2D(k.TEXTURE_2D, 0, e, c.width, c.height, 0, e, f, c.data) : k.texImage2D(k.TEXTURE_2D, 0, e, e, f, a.image);
    ...
    this.setRenderTarget = function (a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            var c = 0 === (a.width & a.width - 1) && 0 === (a.height & a.height - 1), d = H(a.format), e = H(a.type);
            if (b) {
                ...
                for (var f = 0; 6 > f; f++) {
                    ...
                    k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + f, 0, d, a.width,
                        a.height, 0, d, e, null);
                ...
                k.bindFramebuffer(k.FRAMEBUFFER, a.__webglFramebuffer), k.framebufferTexture2D(k.FRAMEBUFFER, k.COLOR_ATTACHMENT0, d, a.__webglTexture, 0), B(a.__webglRenderbuffer, a), c && k.generateMipmap(k.TEXTURE_2D);
        ...
        a ? (b = b ? a.__webglFramebuffer[a.activeCubeFace] : a.__webglFramebuffer, c = a.width, a = a.height, e = d = 0) : (b = null, c = kb, a = Oa, d = Sa, e = Ka);
        b !== ca && (k.bindFramebuffer(k.FRAMEBUFFER,
            b), k.viewport(d, e, c, a), ca = b);
        lb = c;
        ab = a
    };
...
THREE.GeometryUtils = {
    merge: function (a, b) {
        var c, d, e = a.vertices.length, f = b instanceof THREE.Mesh ? b.geometry : b, g = a.vertices, h = f.vertices,
            i = a.faces, j = f.faces, l = a.faceVertexUvs[0], f = f.faceVertexUvs[0];
        ...
        for (n = j.length; m < n; m++) {
            var p = j[m], o, s, t = p.vertexNormals, r = p.vertexColors;
            p instanceof THREE.Face3 ?
                o = new THREE.Face3(p.a + e, p.b + e, p.c + e) : p instanceof THREE.Face4 && (o = new THREE.Face4(p.a + e, p.b + e, p.c + e, p.d + e));
            o.normal.copy(p.normal);
            d && d.multiplyVector3(o.normal);
            g = 0;
            for (h = t.length; g < h; g++) s = t[g].clone(), d && d.multiplyVector3(s), o.vertexNormals.push(s);
        ...
        for (n = f.length; m < n; m++) {
            ...
            g = 0;
            for (h = c.length; g <
            h; g++) d.push(new THREE.UV(c[g].u, c[g].v));
            l.push(d)
        }
        ...
        var d, e, f = a.faces, g = a.vertices, h = f.length, i = 0, j = [], l, m, n, p;
        for (e = 0; e < h; e++) d = f[e], d instanceof THREE.Face3 ? (l = g[d.a], m = g[d.b], n = g[d.c],
            d._area = THREE.GeometryUtils.triangleArea(l, m, n)) : d instanceof THREE.Face4 && (l = g[d.a], m = g[d.b], n = g[d.c], p = g[d.d], d._area1 = THREE.GeometryUtils.triangleArea(l, m, p), d._area2 = THREE.GeometryUtils.triangleArea(m, n, p), d._area = d._area1 + d._area2), i += d._area, j[e] = i;
        d = [];
        ...
        for (c = a.faces.length; b < c; b++) if (d = a.faces[b], d instanceof THREE.Face4) {
            e = d.a;
            var i = d.b, j = d.c, l = d.d, m = new THREE.Face3, n = new THREE.Face3;
        ...
        for (var b = [], c = 0, d = a.faces.length; c < d; c++) {
            ...
            if (f instanceof THREE.Face4) {
                var g = f.a, h = f.b, i = f.c, g = a.vertices[g], h = a.vertices[h], i = a.vertices[i],
                    j = a.vertices[f.d];
                b.push(g.clone());
                b.push(h.clone());
                b.push(i.clone());
        ...
        var c, d, e, f, g, h, i, j, l, m, n, p, o, s, t, r, z, w, q, E = [], A = [];
        c = 0;
        for (d = a.faceVertexUvs.length; c < d; c++) A[c] = [];
        c = 0;
        for (d = a.faces.length; c < d; c++) if (e = a.faces[c], e instanceof THREE.Face3) if (f = e.a, g = e.b, h = e.c, j = a.vertices[f], l = a.vertices[g],
            m = a.vertices[h], p = j.distanceTo(l), o = l.distanceTo(m), n = j.distanceTo(m), p > b || o > b || n > b) {
            i = a.vertices.length;
            w = e.clone();
            q = e.clone();
            p >= o && p >= n ? (j = j.clone(), j.lerpSelf(l, 0.5), w.a = f, w.b = i, w.c = h, q.a = i, q.b = g, q.c = h, 3 === e.vertexNormals.length && (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[1], 0.5), w.vertexNormals[1].copy(f), q.vertexNormals[0].copy(f)), 3 === e.vertexColors.length && (f = e.vertexColors[0].clone(), f.lerpSelf(e.vertexColors[1], 0.5), w.vertexColors[1].copy(f), q.vertexColors[0].copy(f)), e = 0) :
            ...
            a.vertices.push(j);
            f = 0;
            for (g = a.faceVertexUvs.length; f < g; f++) a.faceVertexUvs[f].length && (j = a.faceVertexUvs[f][c], q = j[0], h =
            ...
            w = e.clone();
            q = e.clone();
            p >= o && p >= s && p >= t || s >= o && s >= p && s >= t ? (p = j.clone(), p.lerpSelf(l, 0.5), l = m.clone(), l.lerpSelf(n, 0.5), w.a = f, w.b = r, w.c = z, w.d = i, q.a = r, q.b = g, q.c = h, q.d = z, 4 === e.vertexNormals.length && (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[1], 0.5), g = e.vertexNormals[2].clone(), g.lerpSelf(e.vertexNormals[3], 0.5), w.vertexNormals[1].copy(f),
...
THREE.ImageUtils = {
    crossOrigin: "anonymous", loadTexture: function (a, b, c, d) {
        ...
        for (var h = g.getImageData(0, 0, d, e).data, i = g.createImageData(d, e), j = i.data, l = 0; l < d; l++) for (var m = 0; m < e; m++) {
            var n =
                    0 > m - 1 ? 0 : m - 1, p = m + 1 > e - 1 ? e - 1 : m + 1, o = 0 > l - 1 ? 0 : l - 1,
                s = l + 1 > d - 1 ? d - 1 : l + 1, t = [], r = [0, 0, h[4 * (m * d + l)] / 255 * b];
            ...
            o = t.length;
            for (p = 0; p < o; p++) {
                var s = t[p], z = t[(p + 1) % o], s = [s[0] - r[0], s[1] - r[1], s[2] - r[2]],
                    z = [z[0] - r[0], z[1] - r[1], z[2] - r[2]];
                n.push(c([s[1] *
                z[2] - s[2] * z[1], s[2] * z[0] - s[0] * z[2], s[0] * z[1] - s[1] * z[0]]))
            }
            t = [0, 0, 0];
            for (p = 0; p < n.length; p++) t[0] += n[p][0], t[1] += n[p][1], t[2] += n[p][2];
            t[0] /= n.length;
            t[1] /= n.length;
            t[2] /= n.length;
            r = 4 * (m * d + l);
    ...
    lib: {
        ...
        normal: {
            uniforms: THREE.UniformsUtils.merge([THREE.UniformsLib.fog, THREE.UniformsLib.lights, THREE.UniformsLib.shadowmap, {
                ...
                uNormalScale: {
                    type: "v2", value: new THREE.Vector2(1,
                        1)
                },
...
THREE.FontUtils = {
    faces: {}, face: "helvetiker", weight: "normal", style: "normal", size: 150, divisions: 10, getFace: function () {
        ...
        var f = [], g, h, i, j, l, m, n, p, o, s, t, r = b.glyphs[a] || b.glyphs["?"];
        if (r) {
            if (r.o) {
                ...
                for (a = 0; a < j;) switch (i = b[a++], i) {
                    ...
                    case "q":
                        ...
                        break;
                    case "b":
                        if (i = b[a++] * c + d, l = b[a++] * c, p = b[a++] * c + d, o = b[a++] * -c, s = b[a++] * c + d, t = b[a++] * -c, e.bezierCurveTo(i, l, p, o, s, t), g = f[f.length - 1]) {
                            m = g.x;
                            n = g.y;
                            g = 1;
                            for (h = this.divisions; g <= h; g++) z = g / h, THREE.Shape.Utils.b3(z, m, p, s, i), THREE.Shape.Utils.b3(z, n, o, t, l)
                        }
                }
            }
...
(function (a) {
    ...
    a.Triangulate = function (a, d) {
        ...
        if (3 > e) return null;
        var f = [], g = [], h = [], i, j, l;
        if (0 < b(a)) for (j = 0; j < e; j++) g[j] = j; else for (j = 0; j < e; j++) g[j] = e - 1 - j;
        var m = 2 * e;
        for (j = e - 1; 2 < e;) {
            if (0 >= m--) {
            ...
            a:{
                n = a;
                var p = i, o = j, s = l, t = e, r = g, z = void 0, w = void 0, q = void 0, E = void 0, A = void 0,
                    v = void 0, u = void 0, D = void 0, C = void 0, w = n[r[p]].x, q = n[r[p]].y, E = n[r[o]].x,
                    A = n[r[o]].y, v = n[r[s]].x, u = n[r[s]].y;
                if (1E-10 > (E - w) * (u - q) - (A - q) * (v - w)) n = !1; else {
                    for (z = 0; z < t; z++) if (!(z == p || z == o || z == s)) {
                        var D = n[r[z]].x, C = n[r[z]].y, G = void 0, P = void 0, B = void 0, K = void 0, H = void 0,
                            I = void 0, N = void 0, O = void 0, R = void 0, ga = void 0, M = void 0, J = void 0,
                            G = B = H = void 0, G = v - E, P = u - A, B = w - v, K = q - u, H = E - w, I = A - q,
                            N = D - w, O = C - q, R = D - E, ga = C - A, M = D - v, J = C - u, G = G * ga - P * R,
                            H = H * O - I * N, B = B * J - K * M;
                        if (0 <= G && 0 <= B && 0 <= H) {
                            n = !1;
                            break a
...
THREE.CurvePath.prototype.getBoundingBox = function () {
    ...
    i = 0;
    for (j = a.length; i < j; i++) h = a[i], h.x > b ? b = h.x : h.x < e && (e = h.x), h.y > c ? c = h.y : h.y < f && (f = h.y), m && (h.z > d ? d = h.z : h.z < g && (g = h.z)), l.addSelf(h);
...
THREE.Path.prototype.getPoints = function (a, b) {
    ...
    var a = a || 12, c = [], d, e, f, g, h, i, j, l, m, n, p, o, s;
    d = 0;
    for (e = this.actions.length; d < e; d++) switch (f = this.actions[d], g = f.action, f = f.args, g) {
        ...
        case THREE.PathActions.QUADRATIC_CURVE_TO:
            ...
            m = f[0];
            n = f[1];
            0 < c.length ? (g = c[c.length - 1], p = g.x,
                o = g.y) : (g = this.actions[d - 1].args, p = g[g.length - 2], o = g[g.length - 1]);
            for (f = 1; f <= a; f++) s = f / a, g = THREE.Shape.Utils.b2(s, p, m, h), s = THREE.Shape.Utils.b2(s, o, n, i), c.push(new THREE.Vector2(g, s));
            break;
        case THREE.PathActions.BEZIER_CURVE_TO:
            ...
            j = f[2];
            l = f[3];
            0 < c.length ? (g = c[c.length - 1], p = g.x, o = g.y) : (g = this.actions[d - 1].args, p = g[g.length - 2], o = g[g.length - 1]);
            for (f = 1; f <= a; f++) s = f / a, g = THREE.Shape.Utils.b3(s, p, m, j, h), s = THREE.Shape.Utils.b3(s, o, n, l, i), c.push(new THREE.Vector2(g, s));
            break;
        ...
        case THREE.PathActions.ARC:
            ...
            p = g - j;
            o = 2 * a;
            for (f = 1; f <= o; f++) s = f / o, m || (s = 1 - s), s = j + s * p, g = h + n * Math.cos(s), s = i + n * Math.sin(s), c.push(new THREE.Vector2(g, s));
            break;
...
THREE.Shape.Utils = {
    removeHoles: function (a, b) {
        var c = a.concat(), d = c.concat(), e, f, g, h, i, j, l, m, n, p, o = [];
        for (i = 0; i < b.length; i++) {
            ...
            for (e = 0; e < j.length; e++) {
                n = j[e];
                p = [];
                for (m = 0; m < c.length; m++) l = c[m], l = n.distanceToSquared(l), p.push(l), l < f && (f = l, g = e, h = m)
            }
            ...
            m + n > s + t && (h = p, g = l, 0 > h && (h += c.length), h %= c.length, 0 > g && (g += j.length), g %= j.length, e = 0 <= h - 1 ? h - 1 : c.length - 1, f = 0 <= g - 1 ? g - 1 : j.length - 1);
            m = c.slice(0, h);
            n = c.slice(h);
            p = j.slice(g);
            l = j.slice(0, g);
        ...
        var c = THREE.Shape.Utils.removeHoles(a, b), d = c.allpoints, e = c.isolatedPts,
            c = THREE.FontUtils.Triangulate(c.shape, !1), f, g, h, i, j = {};
        f = 0;
            ...
            for (var p = 0; 3 > p; p++) {
                ...
                if (h.time <= l) {
                    if (j < l) if (this.loop) {
                        ...
                        do g = h, h = this.getNextKeyWith(c, m, h.index + 1); while (h.time < j)
                    }
                    i.prevKey[c] = g;
                    i.nextKey[c] = h
                }
...
THREE.KeyFrameAnimation.prototype.play = function (a, b) {
    if (!this.isPlaying) {
        ...
        for (c = 0; c < d; c++) if (e = this.hierarchy[c], f = this.data.hierarchy[c], e.useQuaternion = !0, void 0 === f.animationCache && (f.animationCache = {}, f.animationCache.prevKey = null, f.animationCache.nextKey = null, f.animationCache.originalMatrix = e instanceof THREE.Bone ? e.skinMatrix :
...
THREE.CubeGeometry = function (a, b, c, d, e, f) {
    function g(a, b, c, d, e, f, g, s) {
        var t, r = h.widthSegments, z = h.heightSegments, w = e / 2, q = f / 2, E = h.vertices.length;
        if ("x" === a && "y" === b || "y" === a && "x" === b) t = "z"; else if ("x" === a && "z" === b || "z" === a && "x" === b) t = "y", z = h.depthSegments; else if ("z" === a && "y" === b || "y" === a && "z" === b) t = "x", r = h.depthSegments;
        var A = r + 1, v = z + 1, u = e / r, D = f / z, C = new THREE.Vector3;
        C[t] = 0 < g ? 1 : -1;
        for (e = 0; e < v; e++) for (f = 0; f < A; f++) {
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    var a = void 0 !== a ? a : 20, b = void 0 !== b ? b : 20, c = void 0 !== c ? c : 100, g = c / 2, d = d || 8,
        e = e || 1, h, i, j = [], l = [];
    for (i = 0; i <= e; i++) {
        var m = [], n = [], p = i / e, o = p * (b - a) + a;
        for (h = 0; h <= d; h++) {
            var s = h / d, t = new THREE.Vector3;
    ...
    for (h = 0; h < d; h++) {
        ...
        1]].clone()) : (m = this.vertices[j[1][h]].clone(), n = this.vertices[j[1][h + 1]].clone());
        m.setY(Math.sqrt(m.x * m.x + m.z * m.z) * c).normalize();
        n.setY(Math.sqrt(n.x * n.x + n.z * n.z) * c).normalize();
        for (i = 0; i < e; i++) {
            var p = j[i][h], o = j[i + 1][h], s = j[i + 1][h + 1], t = j[i][h + 1], r = m.clone(), z = m.clone(),
                w = n.clone(), q = n.clone(), E = l[i][h].clone(), A = l[i + 1][h].clone(), v = l[i + 1][h + 1].clone(),
                u = l[i][h + 1].clone();
    ...
    if (!f && 0 < a) {
        this.vertices.push(new THREE.Vector3(0,
            g, 0));
        for (h = 0; h < d; h++) p = j[0][h], o = j[0][h + 1], s = this.vertices.length - 1, r = new THREE.Vector3(0, 1, 0), z = new THREE.Vector3(0, 1, 0), w = new THREE.Vector3(0, 1, 0), E = l[0][h].clone(), A = l[0][h + 1].clone(), v = new THREE.UV(A.u, 0), this.faces.push(new THREE.Face3(p, o, s, [r, z, w])), this.faceVertexUvs[0].push([E, A, v])
    }
    if (!f && 0 < b) {
        this.vertices.push(new THREE.Vector3(0, -g, 0));
        for (h = 0; h < d; h++) p = j[i][h + 1], o = j[i][h], s = this.vertices.length - 1, r = new THREE.Vector3(0, -1, 0), z = new THREE.Vector3(0, -1, 0), w = new THREE.Vector3(0, -1, 0), E =
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    function e(c, d) {
        ...
        for (J = c.length; 0 <= --J;) {
            ...
            for (var g = 0, h = n + 2 * l, g = 0; g < h; g++) {
                var i = R * g, j = R * (g + 1), m = d + e + i, i = d + f + i, o = d + f + j, j = d + e + j, p = c,
                    s = g, q = h, t = e, u = f, m = m + G, i = i + G, o = o + G, j = j + G;
    ...
    var h = void 0 !==
        b.amount ? b.amount : 100, i = void 0 !== b.bevelThickness ? b.bevelThickness : 6,
        j = void 0 !== b.bevelSize ? b.bevelSize : i - 2, l = void 0 !== b.bevelSegments ? b.bevelSegments : 3,
        m = void 0 !== b.bevelEnabled ? b.bevelEnabled : !0, n = void 0 !== b.steps ? b.steps : 1, p = b.extrudePath, o,
        s = !1, t = b.material, r = b.extrudeMaterial,
        z = void 0 !== b.UVGenerator ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator, w, q, E, A;
    p && (o = p.getSpacedPoints(n), s = !0, m = !1, w = void 0 !== b.frames ? b.frames : new THREE.TubeGeometry.FrenetFrames(p, n, !1), q = new THREE.Vector3, E = new THREE.Vector3,
        A = new THREE.Vector3);
    m || (j = i = l = 0);
    var v, u, D, C = this, G = this.vertices.length, p = a.extractPoints(), P = p.shape, p = p.holes,
        B = !THREE.Shape.Utils.isClockWise(P);
    if (B) {
        P = P.reverse();
        u = 0;
        for (D = p.length; u < D; u++) v = p[u], THREE.Shape.Utils.isClockWise(v) && (p[u] = v.reverse());
        B = !1
    }
    var K = THREE.Shape.Utils.triangulateShape(P, p), B = P;
    u = 0;
    for (D = p.length; u < D; u++) v = p[u], P = P.concat(v);
    var H, I, N, O, R = P.length, ga = K.length, M = [], J = 0, Q = B.length;
    H = Q - 1;
    for (I = J + 1; J < Q; J++, H++, I++) H === Q && (H = 0), I === Q && (I = 0), M[J] = d(B[J], B[H], B[I]);
    var Z =
        [], L, oa = M.concat();
    u = 0;
    for (D = p.length; u < D; u++) {
        ...
        Q = v.length;
        H = Q - 1;
        for (I = J + 1; J < Q; J++, H++, I++) H === Q && (H = 0), I === Q && (I = 0), L[J] = d(v[J], v[H], v[I]);
        Z.push(L);
        oa = oa.concat(L)
    }
    for (H = 0; H < l; H++) {
    ...
    I = j;
    for (J = 0; J < R; J++) O = m ? c(P[J], oa[J], I) : P[J], s ? (E.copy(w.normals[0]).multiplyScalar(O.x), q.copy(w.binormals[0]).multiplyScalar(O.y),
        A.copy(o[0]).addSelf(E).addSelf(q), f(A.x, A.y, A.z)) : f(O.x, O.y, 0);
    for (v = 1; v <= n; v++) for (J = 0; J < R; J++) O = m ? c(P[J], oa[J], I) : P[J], s ? (E.copy(w.normals[v]).multiplyScalar(O.x), q.copy(w.binormals[v]).multiplyScalar(O.y), A.copy(o[v]).addSelf(E).addSelf(q), f(A.x, A.y, A.z)) : f(O.x, O.y, h / n * v);
    for (H = l - 1; 0 <= H; H--) {
        v = H / l;
        N = i * (1 - v);
        I = j * Math.sin(v * Math.PI / 2);
        ...
        for (D = p.length; u < D; u++) {
            ...
            L = Z[u];
            J = 0;
            for (Q = v.length; J < Q; J++) O = c(v[J], L[J], I), s ? f(O.x, O.y + o[n - 1].y,
    ...
    if (m) {
        ...
        for (J = 0; J < ga; J++) h = K[J], g(h[0] + R * n, h[1] + R * n, h[2] + R * n, !1)
    }
    h = 0;
    e(B, h);
    h += B.length;
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
    generateTopUV: function (a, b, c, d, e, f) {
        ...
        var b = a.vertices[e].x, c = a.vertices[e].y, e = a.vertices[e].z, d = a.vertices[f].x, i = a.vertices[f].y,
            f = a.vertices[f].z, j = a.vertices[g].x, l = a.vertices[g].y,
            g = a.vertices[g].z, m = a.vertices[h].x, n = a.vertices[h].y, a = a.vertices[h].z;
        return 0.01 > Math.abs(c - i) ? [new THREE.UV(b, 1 - e), new THREE.UV(d, 1 - f), new THREE.UV(j, 1 - g), new THREE.UV(m, 1 - a)] : [new THREE.UV(c, 1 - e), new THREE.UV(i, 1 - f), new THREE.UV(l, 1 - g), new THREE.UV(n, 1 - a)]
    }
};
...
THREE.ShapeGeometry.prototype.addShape = function (a, b) {
    ...
    f = l.length;
    for (e =
             0; e < j; e++) g = i[e], this.vertices.push(new THREE.Vector3(g.x, g.y, 0));
    for (e = 0; e < f; e++) j = l[e], i = j[0] + h, g = j[1] + h, j = j[2] + h, this.faces.push(new THREE.Face3(i, g, j, null, null, c)), this.faceVertexUvs[0].push(d.generateBottomUV(this, a, b, i, g, j))
};
THREE.LatheGeometry = function (a, b, c) {
    THREE.Geometry.call(this);
    for (var b = b || 12, c = c || 2 * Math.PI, d = [], e = (new THREE.Matrix4).makeRotationZ(c / b), f = 0; f < a.length; f++) d[f] = a[f].clone(), this.vertices.push(d[f]);
    for (var g = b + 1, c = 0; c < g; c++) for (f = 0; f < d.length; f++) d[f] = e.multiplyVector3(d[f].clone()), this.vertices.push(d[f]);
    for (c = 0; c < b; c++) {
        d = 0;
        for (e = a.length; d < e - 1; d++) this.faces.push(new THREE.Face4(c * e + d, (c + 1) % g * e + d, (c + 1) % g * e + (d + 1) % e, c * e + (d + 1) % e)), this.faceVertexUvs[0].push([new THREE.UV(1 - c / b, d / e), new THREE.UV(1 -
...
THREE.PlaneGeometry = function (a, b, c, d) {
    ...
    for (var c = a / 2, e = b / 2, d = this.widthSegments, f = this.heightSegments, g = d + 1, h = f + 1, i = this.width / d, j = this.height / f, l = new THREE.Vector3(0, 0, 1), a = 0; a < h; a++) for (b = 0; b < g; b++) this.vertices.push(new THREE.Vector3(b * i - c, -(a * j - e), 0));
    for (a = 0; a < f; a++) for (b = 0; b < d; b++) c = new THREE.Face4(b + g * a, b + g * (a + 1), b + 1 + g * (a + 1), b + 1 + g * a), c.normal.copy(l), c.vertexNormals.push(l.clone(), l.clone(),
        l.clone(), l.clone()), this.faces.push(c), this.faceVertexUvs[0].push([new THREE.UV(b / d, 1 - a / f), new THREE.UV(b / d, 1 - (a + 1) / f), new THREE.UV((b + 1) / d, 1 - (a + 1) / f), new THREE.UV((b + 1) / d, 1 - a / f)]);
    this.computeCentroids()
};
...
THREE.SphereGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (var d = void 0 !== d ? d : 0, e = void 0 !== e ? e : 2 * Math.PI, f = void 0 !== f ? f : 0, g = void 0 !== g ? g : Math.PI, c = [], h = [], b = 0; b <= this.heightSegments; b++) {
        for (var i = [], j = [], a = 0; a <= this.widthSegments; a++) {
            var l = a / this.widthSegments, m = b / this.heightSegments, n = new THREE.Vector3;
    ...
    for (b = 0; b < this.heightSegments; b++) for (a = 0; a < this.widthSegments; a++) {
        var d = c[b][a + 1], e = c[b][a], f = c[b + 1][a], g = c[b + 1][a + 1],
            i = this.vertices[d].clone().normalize(), j = this.vertices[e].clone().normalize(),
            l = this.vertices[f].clone().normalize(), m = this.vertices[g].clone().normalize(), n = h[b][a + 1].clone(),
            p = h[b][a].clone(), o = h[b + 1][a].clone(), s =
                h[b + 1][a + 1].clone();
        Math.abs(this.vertices[d].y) === this.radius ? (this.faces.push(new THREE.Face3(d, f, g, [i, l, m])), this.faceVertexUvs[0].push([n, o, s])) : Math.abs(this.vertices[f].y) === this.radius ? (this.faces.push(new THREE.Face3(d, e, f, [i, j, l])), this.faceVertexUvs[0].push([n, p, o])) : (this.faces.push(new THREE.Face4(d, e, f, g, [i, j, l, m])), this.faceVertexUvs[0].push([n, p, o, s]))
    }
    this.computeCentroids();
    this.computeFaceNormals();
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
    ...
    this.grid = [];
    var g, h, f = this.segments + 1, i, j, l, m = new THREE.Vector3, n, p, o,
    ...
    for (b = 0; b < f; b++) {
        ...
        for (d = 0; d < this.radiusSegments; d++) i = 2 * (d / this.radiusSegments) * Math.PI, j = -this.radius * Math.cos(i), i = this.radius * Math.sin(i), m.copy(l), m.x += j * g.x + i * h.x, m.y += j * g.y + i * h.y, m.z += j * g.z + i * h.z, this.grid[b][d] = this.vertices.push(new THREE.Vector3(m.x, m.y, m.z)) - 1
    }
...
THREE.TubeGeometry.FrenetFrames = function (a, b, c) {
    ...
    new THREE.Vector3;
    var e = [], f = [], g = [], h = new THREE.Vector3, i = new THREE.Matrix4, b = b + 1, j, l, m;
    this.tangents = e;
    this.normals = f;
    this.binormals = g;
    ...
    f[0].cross(e[0], h);
    g[0].cross(e[0], f[0]);
    for (j = 1; j < b; j++) f[j] = f[j - 1].clone(), g[j] = g[j - 1].clone(), h.cross(e[j - 1], e[j]), 1E-4 < h.length() && (h.normalize(), d = Math.acos(e[j - 1].dot(e[j])), i.makeRotationAxis(h, d).multiplyVector3(f[j])), g[j].cross(e[j], f[j]);
    if (c) {
        d = Math.acos(f[0].dot(f[b - 1]));
        d /= b - 1;
        0 < e[0].dot(h.cross(f[0], f[b - 1])) && (d = -d);
        for (j = 1; j < b; j++) i.makeRotationAxis(e[j], d * j).multiplyVector3(f[j]), g[j].cross(e[j], f[j])
    }
};
...
THREE.ParametricGeometry = function (a, b, c, d) {
    THREE.Geometry.call(this);
    var e = this.vertices, f = this.faces, g = this.faceVertexUvs[0], d = void 0 === d ? !1 : d, h, i, j, l, m = b + 1;
    for (h = 0; h <= c; h++) {
        l = h / c;
        for (i = 0; i <= b; i++) j = i / b, j = a(j, l), e.push(j)
    }
    var n, p, o, s;
    for (h = 0; h < c; h++) for (i = 0; i < b; i++) a = h * m + i, e = h * m + i + 1, l = (h + 1) * m + i, j = (h + 1) * m + i + 1, n = new THREE.UV(i / b, h / c), p = new THREE.UV((i + 1) / b, h / c), o = new THREE.UV(i / b, (h + 1) / c), s = new THREE.UV((i + 1) / b, (h + 1) / c), d ? (f.push(new THREE.Face3(a, e, l)), f.push(new THREE.Face3(e, j, l)), g.push([n, p,
        o]), g.push([p, s, o])) : (f.push(new THREE.Face4(a, e, j, l)), g.push([n, p, s, o]));
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
};
...
THREE.ConvexGeometry = function (a) {
    ...
    for (var c = [[0, 1, 2], [0, 2, 1]], d = 3; d < a.length; d++) {
        ...
        for (var g = [], h = 0; h < c.length;) {
            var i = c[h], j = f, l = a[i[0]], m;
            m = l;
            var n = a[i[1]], p = a[i[2]], o = new THREE.Vector3, s = new THREE.Vector3;
            o.sub(p, n);
            s.sub(m, n);
            o.crossSelf(s);
            o.normalize();
...
THREE.DirectionalLightHelper = function (a, b, c) {
    ...
    this.color.g *= d;
    this.color.b *= d;
    var d = this.color.getHex(), e = new THREE.SphereGeometry(b, 16, 8),
        f = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), g = new THREE.MeshBasicMaterial({color: d, fog: !1}),
    ...
    a.target.properties.targetInverse && (b = new THREE.SphereGeometry(b,
        8, 4), c = new THREE.MeshBasicMaterial({
        color: d,
        wireframe: !0,
        fog: !1
        ...
        transparent: !0,
        fog: !1
    }), d = new THREE.Geometry, d.vertices.push(this.position.clone()), d.vertices.push(this.targetSphere.position.clone()),
        d.computeLineDistances(), this.targetLine = new THREE.Line(d, a), this.targetLine.properties.isGizmo = !0);
...
THREE.HemisphereLightHelper = function (a, b, c) {
    ...
    for (var d = this.groundColor.getHex(), f = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0, 0.5 * Math.PI), g = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0.5 *
        Math.PI, Math.PI), h = new THREE.MeshBasicMaterial({
        color: e,
        fog: !1
    }), i = new THREE.MeshBasicMaterial({
        color: d,
        fog: !1
    }), j = 0, l = f.faces.length; j < l; j++) f.faces[j].materialIndex = 0;
    j = 0;
    ...
    this.lightArrowGround = new THREE.ArrowHelper(new THREE.Vector3(0,
...
THREE.SpotLightHelper = function (a, b, c) {
    ...
    this.color.b *= d;
    var d = this.color.getHex(), e = new THREE.SphereGeometry(b, 16, 8),
        f = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), g = new THREE.CylinderGeometry(1E-4, 1, 1, 8, 1, !0),
        h = new THREE.Matrix4;
    h.rotateX(-Math.PI / 2);
    h.translate(new THREE.Vector3(0,
        -0.5, 0));
    g.applyMatrix(h);
    var i = new THREE.MeshBasicMaterial({color: d, fog: !1}), h = new THREE.LineBasicMaterial({color: d, fog: !1}),
        j = new THREE.MeshBasicMaterial({color: d, fog: !1, wireframe: !0, opacity: 0.3, transparent: !0});
    this.lightArrow = new THREE.ArrowHelper(this.direction, null, c, d);
    ...
    this.lightArrow.cone.material.fog = !1;
    this.lightArrow.line.material.fog =
        !1;
    this.lightRays = new THREE.Line(f, h, THREE.LinePieces);
    ...
    a.target.properties.targetInverse && (b = new THREE.SphereGeometry(b, 8, 4), f = new THREE.MeshBasicMaterial({
        ...
        transparent: !0,
        fog: !1
    }), d = new THREE.Geometry, d.vertices.push(this.position.clone()), d.vertices.push(this.targetSphere.position.clone()), d.computeLineDistances(), this.targetLine =
        new THREE.Line(d, a), this.targetLine.properties.isGizmo = !0);
    this.properties.isGizmo = !0
};
...
THREE.GeometryUtils.computeEdgeFaces = function (a) {
    ...
    c = 0;
    for (d = a.faces.length; c < d; c++) e = a.faces[c], e instanceof THREE.Face3 ? (f = h(e.a, e.b), b(f, c), f = h(e.b, e.c), b(f, c), f = h(e.c, e.a), b(f, c)) : e instanceof THREE.Face4 && (f = h(e.a, e.b), b(f, c), f = h(e.b, e.c), b(f, c), f = h(e.c, e.d), b(f, c), f = h(e.d, e.a), b(f, c));
    return g
};
THREE.SubdivisionModifier.prototype.smooth = function (a) {
    ...
    function e(a, b, d, e, g, h, m) {
        ...
        if (l.useOldVertexColors) {
            ...
            for (var o, p, q, r = 0; 4 > r; r++) {
                ...
                o = new THREE.Color;
                o.setRGB(0, 0, 0);
                for (var s = 0; s < q.length; s++) p = g.vertexColors[q[s] -
                1], o.r += p.r, o.g += p.g, o.b += p.b;
                o.r /= q.length;
                o.g /= q.length;
                o.b /= q.length;
                n.vertexColors[r] = o
        ...
        i.push(n);
        l.supportUVs && (g = [f(a, ""), f(b, m), f(d, m), f(e, m)], g[0] ? g[1] ? g[2] ? g[3] ? j.push(g) : c("d :( ", e + ":" + m) : c("c :( ", d + ":" + m) : c("b :( ", b + ":" + m) : c("a :( ", a + ":" + m))
    }

    function f(a, b) {
        var e = a + ":" + b, f = w[e];
        return !f ? (a >= s && a < s + o.length ? c("face pt") : c("edge pt"), d("warning, UV not found for", e), null) : f
    }

    function g(a, b, c) {
        var e = a + ":" + b;
        e in w ? d("dup vertexNo", a, "oldFaceNo", b, "value", c, "key", e, w[e]) : w[e] = c
    }

    var h = [],
        i = [], j = [], l = this, m = THREE.GeometryUtils.orderedKey, n = THREE.GeometryUtils.computeEdgeFaces,
        p = a.vertices, o = a.faces, s = p.length, h = p.concat(), t = [], r = {}, z = {}, w = {}, q, E, A, v, u,
        D = a.faceVertexUvs[0], C;
    c("originalFaces, uvs, originalVerticesLength", o.length, D.length, s);
    if (l.supportUVs) {
        q = 0;
        for (E = D.length; q < E; q++) {
            A = 0;
            for (v = D[q].length; A < v; A++) C = o[q]["abcd".charAt(A)], g(C, q, D[q][A])
        }
    }
    ...
    q = 0;
    for (E = o.length; q < E; q++) u = o[q], t.push(u.centroid),
        h.push(u.centroid), l.supportUVs && (v = new THREE.UV, u instanceof THREE.Face3 ? (v.u = f(u.a, q).u + f(u.b, q).u + f(u.c, q).u, v.v = f(u.a, q).v + f(u.b, q).v + f(u.c, q).v, v.u /= 3, v.v /= 3) : u instanceof THREE.Face4 && (v.u = f(u.a, q).u + f(u.b, q).u + f(u.c, q).u + f(u.d, q).u, v.v = f(u.a, q).v + f(u.b, q).v + f(u.c, q).v + f(u.d, q).v, v.u /= 4, v.v /= 4), g(s + q, "", v));
    var n = n(a), P;
    E = 0;
    var B, K;
    G = {};
    ...
    for (q in n) if (C = n[q], u = C[0], P = C[1], B = q.split("_"), K = B[0], B = B[1], v = new THREE.Vector3, b(0 < C.length, "an edge without faces?!"), 1 == C.length ? (v.addSelf(p[K]), v.addSelf(p[B]), v.multiplyScalar(0.5)) : (v.addSelf(t[u]), v.addSelf(t[P]), v.addSelf(p[K]), v.addSelf(p[B]), v.multiplyScalar(0.25)), r[q] = s + o.length + E, h.push(v), E++, l.supportUVs) v = new THREE.UV, v.u = f(K, u).u +
        f(B, u).u, v.v = f(K, u).v + f(B, u).v, v.u /= 2, v.v /= 2, g(r[q], u, v), 2 <= C.length && (b(2 == C.length, "did we plan for more than 2 edges?"), v = new THREE.UV, v.u = f(K, P).u + f(B, P).u, v.v = f(K, P).v + f(B, P).v, v.u /= 2, v.v /= 2, g(r[q], P, v));
    c("-- Step 2 done");
    var N, O;
    v = ["123", "12", "2", "23"];
    P = ["123", "23", "3", "31"];
    var H = ["123", "31", "1", "12"], I = ["1234", "12", "2", "23"], R = ["1234", "23", "3", "34"],
        ga = ["1234", "34", "4", "41"], M = ["1234", "41", "1", "12"];
    q = 0;
    for (E = t.length; q < E; q++) u = o[q], C = s + q, u instanceof THREE.Face3 ? (K = m(u.a, u.b), B = m(u.b,
        u.c), N = m(u.c, u.a), e(C, r[K], u.b, r[B], u, v, q), e(C, r[B], u.c, r[N], u, P, q), e(C, r[N], u.a, r[K], u, H, q)) : u instanceof THREE.Face4 ? (K = m(u.a, u.b), B = m(u.b, u.c), N = m(u.c, u.d), O = m(u.d, u.a), e(C, r[K], u.b, r[B], u, I, q), e(C, r[B], u.c, r[N], u, R, q), e(C, r[N], u.d, r[O], u, ga, q), e(C, r[O], u.a, r[K], u, M, q)) : c("face should be a face!", u);
    r = new THREE.Vector3;
    u = new THREE.Vector3;
    q = 0;
    for (E = p.length; q < E; q++) if (void 0 !== G[q]) {
        r.set(0, 0, 0);
        u.set(0, 0, 0);
        ...
        P = 0;
        if (v) {
            for (A = 0; A < K; A++) if (C = G[q][A], H = 1 == n[m(C[0], C[1])].length) C = p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2), u.addSelf(C), P++;
            u.divideScalar(4);
            b(2 == P, "should have only 2 boundary edges")
        } else {
            for (A = 0; A < K; A++) C = G[q][A], C = p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2), u.addSelf(C);
            u.divideScalar(K)
        }
        B.addSelf(p[q]);
        v ? (B.divideScalar(2), B.addSelf(u)) : (B.multiplyScalar(K - 3), B.addSelf(r), B.addSelf(u.multiplyScalar(2)), B.divideScalar(K));
        h[q] = B
    }
    a.vertices = h;
    a.faces = i;
...
THREE.MorphBlendMesh.prototype.update = function (a) {
    for (var b = 0, c = this.animationsList.length; b < c; b++) {
        ...
        if (d.active) {
            ...
            if (d.mirroredLoop) {
                if (d.time > d.duration || 0 > d.time) if (d.direction *= -1, d.time > d.duration && (d.time = d.duration, d.directionBackwards = !0), 0 > d.time) d.time = 0, d.directionBackwards = !1
...
THREE.LensFlarePlugin = function () {
    ...
    this.render = function (a, d, e, r) {
        var a = a.__webglFlares, z = a.length;
        if (z) {
            var w = new THREE.Vector3, q = r / e, E = 0.5 * e, A = 0.5 * r, v = 16 / r, u = new THREE.Vector2(v * q, v),
                D = new THREE.Vector3(1, 1, 0), C = new THREE.Vector2(1, 1), G = n, v = m;
            b.useProgram(l);
            p || (b.enableVertexAttribArray(m.vertex), b.enableVertexAttribArray(m.uv), p = !0);
            ...
            b.depthMask(!1);
            var P, B, K, H, I;
            for (P = 0; P < z; P++) if (v = 16 / r, u.set(v * q, v), H = a[P], w.set(H.matrixWorld.elements[12], H.matrixWorld.elements[13], H.matrixWorld.elements[14]), d.matrixWorldInverse.multiplyVector3(w), d.projectionMatrix.multiplyVector3(w), D.copy(w), C.x = D.x * E + E, C.y = D.y * A + A, j || 0 < C.x && C.x < e && 0 < C.y && C.y < r) {
                ...
                b.bindTexture(b.TEXTURE_2D, i);
                b.copyTexImage2D(b.TEXTURE_2D, 0, b.RGBA, C.x - 8, C.y - 8, 16, 16, 0);
                ...
                b.enable(b.BLEND);
                B = 0;
                for (K = H.lensFlares.length; B < K; B++) I = H.lensFlares[B], 0.001 < I.opacity && 0.001 < I.scale && (D.x = I.x, D.y = I.y, D.z = I.z, v = I.size * I.scale / r, u.x = v * q, u.y = v, b.uniform3f(G.screenPosition, D.x, D.y, D.z), b.uniform2f(G.scale, u.x, u.y), b.uniform1f(G.rotation, I.rotation), b.uniform1f(G.opacity, I.opacity), b.uniform3f(G.color, I.color.r,
...
THREE.ShadowMapPlugin = function () {
    ...
    this.update = function (l, m) {
        ...
        b.setDepthTest(!0);
        n = 0;
        for (p = l.__lights.length; n < p; n++) if (o = l.__lights[n], o.castShadow) if (o instanceof THREE.DirectionalLight && o.shadowCascade) for (t = 0; t < o.shadowCascadeCount; t++) {
            var A;
            if (o.shadowCascadeArray[t]) A = o.shadowCascadeArray[t]; else {
                q = o;
                z = t;
                ...
                w = A.pointsWorld;
                r = A.pointsFrustum;
                for (var v = 0; 8 > v; v++) w[v] = new THREE.Vector3, r[v] = new THREE.Vector3;
        ...
        for (p = E.length; n < p; n++) {
            o = E[n];
            o.shadowMap || (o.shadowMap = new THREE.WebGLRenderTarget(o.shadowMapWidth, o.shadowMapHeight, {
                minFilter: THREE.LinearFilter,
                magFilter: THREE.LinearFilter,
                format: THREE.RGBAFormat
            }), o.shadowMapSize = new THREE.Vector2(o.shadowMapWidth, o.shadowMapHeight), o.shadowMatrix = new THREE.Matrix4);
            if (!o.shadowCamera) {
                if (o instanceof THREE.SpotLight) o.shadowCamera =
                    new THREE.PerspectiveCamera(o.shadowCameraFov, o.shadowMapWidth / o.shadowMapHeight, o.shadowCameraNear, o.shadowCameraFar); else if (o instanceof THREE.DirectionalLight) o.shadowCamera = new THREE.OrthographicCamera(o.shadowCameraLeft, o.shadowCameraRight, o.shadowCameraTop, o.shadowCameraBottom, o.shadowCameraNear, o.shadowCameraFar); else {
            ...
            o.shadowCameraVisible && !o.cameraHelper && (o.cameraHelper =
                new THREE.CameraHelper(o.shadowCamera), o.shadowCamera.add(o.cameraHelper));
            if (o.isVirtual && A.originalCamera == m) {
                ...
                for (z = 0; 8 > z; z++) if (w = q[z], w.copy(r[z]), THREE.ShadowMapPlugin.__projector.unprojectVector(w, t), s.matrixWorldInverse.multiplyVector3(w), w.x < i.x && (i.x = w.x), w.x > j.x && (j.x = w.x), w.y < i.y && (i.y = w.y), w.y > j.y && (j.y = w.y), w.z < i.z && (i.z = w.z), w.z > j.z) j.z = w.z;
                s.left = i.x;
                s.right =
                    j.x;
                s.top = j.y;
            ...
            t._viewMatrixArray ||
            (t._viewMatrixArray = new Float32Array(16));
            t._projectionMatrixArray || (t._projectionMatrixArray = new Float32Array(16));
            ...
            q = l.__webglObjects;
            o = 0;
            for (s = q.length; o < s; o++) if (z = q[o], r = z.object, z.render = !1, r.visible && r.castShadow && (!(r instanceof THREE.Mesh || r instanceof THREE.ParticleSystem) ||
                !r.frustumCulled || g.contains(r))) r._modelViewMatrix.multiply(t.matrixWorldInverse, r.matrixWorld), z.render = !0;
            o = 0;
            for (s = q.length; o < s; o++) z = q[o], z.render && (r = z.object, z = z.buffer, v = r.material instanceof THREE.MeshFaceMaterial ? r.material.materials[0] : r.material, w = 0 < r.geometry.morphTargets.length && v.morphTargets, v = r instanceof THREE.SkinnedMesh && v.skinning, w = r.customDepthMaterial ? r.customDepthMaterial : v ? w ? f : e : w ? d : c, z instanceof THREE.BufferGeometry ? b.renderBufferDirect(t, l.__lights, null, w, z, r) : b.renderBuffer(t,
                l.__lights, null, w, z, r));
            q = l.__webglObjectsImmediate;
            o = 0;
            for (s = q.length; o < s; o++) z = q[o], r = z.object, r.visible && r.castShadow && (r._modelViewMatrix.multiply(t.matrixWorldInverse, r.matrixWorld), b.renderImmediateObject(t, l.__lights, null, c, r))
        }
        n = b.getClearColor();
        p = b.getClearAlpha();
...
THREE.SpritePlugin = function () {
    ...
    this.init = function (a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, g);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, e, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, n = b.createProgram(), p = b.createShader(b.FRAGMENT_SHADER),
        ...
        j.uvOffset = b.getUniformLocation(h,
            "uvOffset");
    ...
    this.render = function (d, e, p, o) {
        var s = d.__webglSprites, t = s.length;
        if (t) {
            var r = i, z = j, w = o / p, p = 0.5 * p, q = 0.5 * o, E = !0;
            b.useProgram(h);
            l || (b.enableVertexAttribArray(r.position),
                b.enableVertexAttribArray(r.uv), l = !0);
            b.disable(b.CULL_FACE);
            b.enable(b.BLEND);
            b.depthMask(!0);
            b.bindBuffer(b.ARRAY_BUFFER, f);
            ...
            b.uniform1i(z.map, 0);
            var A = r = 0, v = d.fog;
            v ? (b.uniform3f(z.fogColor, v.color.r, v.color.g, v.color.b), v instanceof THREE.Fog ? (b.uniform1f(z.fogNear, v.near),
                b.uniform1f(z.fogFar, v.far), b.uniform1i(z.fogType, 1), A = r = 1) : v instanceof THREE.FogExp2 && (b.uniform1f(z.fogDensity, v.density), b.uniform1i(z.fogType, 2), A = r = 2)) : (b.uniform1i(z.fogType, 0), A = r = 0);
            for (var u, D = [], v = 0; v < t; v++) u = s[v], u.visible && 0 !== u.opacity && (u.useScreenCoordinates ? u.z = -u.position.z : (u._modelViewMatrix.multiply(e.matrixWorldInverse, u.matrixWorld), u.z = -u._modelViewMatrix.elements[14]));
            s.sort(a);
            for (v = 0; v < t; v++) if (u = s[v], u.visible && 0 !== u.opacity && u.map && u.map.image && u.map.image.width) u.useScreenCoordinates ?
                ...
                u.uvOffset.x, u.uvOffset.y), b.uniform2f(z.alignment, u.alignment.x, u.alignment.y), b.uniform1f(z.opacity, u.opacity), b.uniform3f(z.color, u.color.r, u.color.g, u.color.b), b.uniform1f(z.rotation, u.rotation), b.uniform2fv(z.scale, D), u.mergeWith3D && !E ? (b.enable(b.DEPTH_TEST), E = !0) : !u.mergeWith3D && E && (b.disable(b.DEPTH_TEST), E = !1), c.setBlending(u.blending, u.blendEquation, u.blendSrc, u.blendDst), c.setTexture(u.map, 0), b.drawElements(b.TRIANGLES, 6, b.UNSIGNED_SHORT, 0);
            b.enable(b.CULL_FACE);
            b.enable(b.DEPTH_TEST);
            b.depthMask(!0)
        }
...
THREE.DepthPassPlugin = function () {
    ...
    this.init = function (g) {
        ...
        e = new THREE.ShaderMaterial({
            fragmentShader: g.fragmentShader, vertexShader: g.vertexShader,
    ...
    this.update = function (i, j) {
        ...
        s = i.__webglObjects;
        l = 0;
        for (m = s.length; l < m; l++) if (n = s[l], o = n.object, n.render = !1, o.visible && (!(o instanceof THREE.Mesh || o instanceof THREE.ParticleSystem) || !o.frustumCulled ||
            g.contains(o))) o._modelViewMatrix.multiply(j.matrixWorldInverse, o.matrixWorld), n.render = !0;
        var t;
        l = 0;
        for (m = s.length; l < m; l++) if (n = s[l], n.render && (o = n.object, n = n.buffer, !(o instanceof THREE.ParticleSystem) || o.customDepthMaterial)) (t = o.material instanceof THREE.MeshFaceMaterial ? o.material.materials[0] : o.material) && b.setMaterialFaces(o.material), p = 0 < o.geometry.morphTargets.length && t.morphTargets, t = o instanceof THREE.SkinnedMesh && t.skinning, p = o.customDepthMaterial ? o.customDepthMaterial : t ? p ? f : e : p ? d : c, n instanceof
        THREE.BufferGeometry ? b.renderBufferDirect(j, i.__lights, null, p, n, o) : b.renderBuffer(j, i.__lights, null, p, n, o);
        s = i.__webglObjectsImmediate;
        l = 0;
        for (m = s.length; l < m; l++) n = s[l], o = n.object, o.visible && (o._modelViewMatrix.multiply(j.matrixWorldInverse, o.matrixWorld), b.renderImmediateObject(j, i.__lights, null, c, o));
        l = b.getClearColor();
        m = b.getClearAlpha();
